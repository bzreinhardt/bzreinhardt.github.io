...
Institutionally constrained activity is a useful and precise way to think about the vibe that the world could be on a more wonderful trajectory than it's on right now.[^fn10] 
...
On top of flexibility and long-term survivability, profit also creates an extremely tight feedback loop between an organization and the outside world.[^fn85] Arguably, cold, hard cash is one of the only metrics that isn't automatically subject to Goodhart's Law[^fn86] --- if your organization's goal is genuinely selling a product or service, profit is a hard metric to game short of literal fraud.
...
3\. **Personal Computers** **---** nobody was asking for most of the pieces of the Mother of All Demos.[^fn89] Instead of collaborative shopping lists and voice calls, the military wanted a computer that could help commanders understand what was happening with nukes and battles.
...
Knowledge is non-rivalrous. Your knowledge of airplane building does not prevent me from knowing how to build an airplane. Once knowledge is no longer secret, it generally becomes non-excludable as well. As a result, a lot of research resembles a public good.[^fn90]
...
The direct ways to capture the value from research are to patent[^fn99] it or build a product around it (and leverage trade secrets.) Other possibilities are more indirect and 'credit based': consulting, speaking fees, or leveraging reputation to get more lucrative positions later.
...
It's worth noting two historical facts about patents that shed some light on their limitations. Patents have gone from well-reviewed descriptions of already-built mechanical inventions to hastily-reviewed descriptions of everything from software to biotech written by lawyers. The number of patents issued in the US has increased by four orders of magnitude since the patent office opened --- from 33 in 1791 to 354,430 in 2019.[^fn100] The number of patent reviewers hasn't increased anywhere near that much. On top of all of that, patents weren't even created as a value-capture tool for discovery or invention. Instead, patents started as a way for monarchs to increase their income without going through Parliament by granting temporary monopolies.[^fn101] Of course, the modern patent system is explicitly meant to incentivize innovation so this might be nothing more than a historical anecdote.
...
This combinatorial drag from patents is why In most industries outside of pharma and chemicals, patents are a net drag on innovation.[^fn102] Chemicals and drugs usually have a 1:1 correspondence between patents and products. On the other hand, semiconductors and software can have dozens of patents in a single product.
...
2. To avoid introducing a new term I'll be using the term 'creation' to describe nebulous discovery/invention/potential innovation type things. [^fn103]
...
Historically, new legal structures have enabled new classes of activity. The creation of joint stock companies in the 1600's enabled larger and riskier private ventures like the East India Company[^fn115] and arguably enabled a lot of English settlement in North America. The creation of limited liability corporations in the mid 19th century helped enable the railroad boom first in Britain and then in the US.[^fn116] In 2020, SPACs made going public a reasonable move for several non-software technology companies that may not have happened otherwise.
...
![][vc_fund_structure]The structure of a typical VC firm[^fn119]

At the end of the day legal structures are "just" contracts that determine how money flows and how decisions are made both within and between one or more taxable entities. We generally think of organizations in terms of these tax designations: LLC, C-Corp, 501(c)(3), etc.[^fn120] Our custom of using tax designation as one of the primary descriptions of an organization hints at the fact that taxes matter a lot! Tax designations can place requirements on organizational structure like the need for a board of directors and determine both what happens to money that comes in (eg. C-corps and their shareholders are both taxed, only the shareholders of an LLC are taxed) and what an organization is allowed to spend money on (eg. 501(c)(3)s can only spend money related to their official mission).
...
OpenAI's capped-profit/nonprofit structure [^fn124]is a great example of an organization playing with legal structures to match their own situation and shape incentives in ways that wouldn't otherwise be possible. They need to be able to pay AI researchers top dollar, while at the same time their nominal mission is to keep powerful AI technology from being captured by organizations whose incentives are to use it to maximize shareholder value.[^fn125]
...
Externalized research is a load-bearing component of the DARPA model [^fn166]because it enables minimal full-time staff, spinning up or spinning down projects quickly, access rare talents and machines, and tying different approaches in parallel. However, not only is [it hard to capture value from research][It is hard to capture value from research], it is especially hard to capture value from externalized research!

The role of DARPA as a in-between organization [^fn167]that acts as glue for a broader innovation ecosystem feels weirdly important. That role also plays awkwardly with value capture.  If the whole goal is to kick off a *community*[^fn168], many entities need to feel like they can capture value from an innovation and might feel threatened or hesitate to collaborate with a purely for-profit venture.

## Is there a minimum effective budget to generate outlier results ##

[It is important for big things to start small][] --- many attempts to replicate DARPA's results start too big[^fn169]. So it makes sense to ask: is there a minimum effective budget to generate outlier results? Can you start with a tenth of DARPA's budget? A hundredth? A thousandth?
...
A back of the envelope calculation suggests that if each program generously has a 10% chance of success (DARPA has a 5-10% program success rate)[^fn170] then you need to run at least seven programs to give yourself a 50% chance of at least one program being successful[^fn171]. Whether these programs are run in series or parallel depends on available funding. However, if it takes five years to run a full program, running them in series could take a decade or more (assuming several unsuccessful programs are terminated early) to even demonstrate organizational feasibility. And this isn't "ten years to a $1B IPO" --- it's "ten years to getting a really promising technology out into the world that given another decade might produce a measurable impact." Given the absurd timeline of running programs in series, running several programs in parallel is important. The necessity of both starting small and running several programs in parallel to even demonstrate feasibility is one of the core tensions inherent in riffing on DARPA.

The question of minimum program budgets is tricky. Let's first look at some comparison numbers. In the years 2018-2020 among DARPA programs not focused on assembly and production, the minimum budget was $2m, the maximum budget was $31.4m and the average budget was $12m.[^fn172] The ARPA IPTO directorate that midwifed the personal computer started with a budget of $(2020)47M in 1962.[^fn173] ARPA-E vacillates between \~$200-$300M/year, has about 50 programs running at any time, which comes out to roughly $4m to $6m per program. IARPA's budget is classified. Could a program go below a couple million dollars a year and still be effective? There are arguments both ways. On the one hand you could argue that surely bureaucratic inefficiency is pushing those budgets higher than they need to be. On the other hand, it might be that the sort of work that it's most valuable for a DARPA-riff to do needs a relatively large budget, otherwise it happen in other institutions. Without strong reasons to believe otherwise (which we don't have), it seems irresponsible to assume that you could run impactful programs for significantly less than DARPA. The saving grace is that programs don't need to start at full-budget but can ramp up over a year or two. 
...
A few organizations make a significant chunk of money from licensing revenue. Between 2008 and 2012 IBM made over $1B/year in licensing revenue.[^fn174] Intellectual Ventures' primary business model revolves around licensing. Universities are another example. [From an article on licensing revenues in 2015](https://www.latimes.com/local/education/la-me-uc-patents-20151011-story.html):
...
The many-small-donors end of the spectrum tends to push organizations towards either short-termism or constrained sizes. You'll notice that Charities that depend on many small donations are constantly asking for donations --- everybody has seen Wikipedia's yearly banner; and many of us remember asking for pennies for UNICEF on Halloween. Even if they aren't cash-strapped, Charities need to get 33% of their income from 'small donors'[^fn183] in order to maintain their legal status (and associated tax benefits for themselves and donors)[^fn184]. "Yeah, we're still struggling with the same experiments we were last year" is a common occurrence in research but isn't a great way to get people excited about donating, nudging charities towards shorter time horizons and flashier results. 
...
6. If a single person is bankrolling an entire project they (for good reason!) tend to feel some ownership over it. Depending on the person, this attitude may be problematic for an organization that benefits from opacity and independence.[^fn185] 
...
The advantage of government grants is that they come with relatively\*[^fn198] few strings attached. Governments don't care about either direct monetary ROI and can nominally act on long timescales. The government can actually capture value from public goods, so their incentives are nominally aligned[^fn199] with an organization whose goal is to create impactful technology. Governments also deploy a massive amount of money so the operating budget of a DARPA-riff isn't outrageous compared to other expenditures.
...
Arguably, [DeepMind](https://deepmind.com/) is a great example of the mitochondria maneuver.[^fn203] An AI research lab, they were acquired by Google in 2014 but unlike most acquired companies, they have maintained relative independence to do high-quality long-term work.[^fn204] As long as they continue to have hits every few years (AlphaGo, AlphaFold) and some of their work directly helps the mothership (some of their work makes Google's data centers more efficient) Alphabet seems willing to heavily subsidize their almost $1B budget. [^fn205]However, the fact that the Alphabet-DeepMind relationship meets the three criteria for healthy industrial labs should make you skeptical whether the mitochondria maneuver can be accomplished in other (lower-margin, less-clearly-aligned) domains. 
...
Let's consider the question "What makes a good organization mission?" with respect to PARPA. There's something immaculate about good organizational missions, as if they spring fully formed from someone's head. Unfortunately I'm not that good. Instead the most truthful (and hopefully interesting!) approach is to unpack the process. (This will also be a bit self-indulgent so forgive me.) If you don't want to ruin the magic, [you can skip to the conclusion.][Shifting Technology from Impossible to Inevitable]
...
[^fn1]: \<sidenote\> A term (as far as I can tell) coined by Arathi Prabhakar in[ In the Realm of the Barely Feasible](https://issues.org/realm-of-the-barely-feasible-innovation-darpa-prabhakar/)

[^fn2]: It's notable that the disciplines can differ both horizontally (ie. theoretical chemists, mathematicians, and physicists) and vertically (ie. Theorists, experimentalists, engineers, manufacturers)

[^fn3]: Condition \#3 was originally "1+2 are insufficient if the technology the lab works on isn't tied into the company's core business." However, this isn't quite right. There are situations where technology work on the core product can have nothing to do with existential risks to the business (for example Salesforce.) Similarly there are situations where technology work has little to do with the core product but addresses an existential threat (for example flashy research at Bell Labs keeping regulators from breaking up the monopoly.)

[^fn4]: \<sidenote\> For a deeper dive on DARPA and a refresher on what the DARPA model entails see [Why DARPA Works](http://benjaminreinhardt.com/wddw)

[^fn5]: Theseus killed the minotaur but ultimately caused his father to commit suicide.Success? Failure?

[^fn6]: \<sidenote\> As far as I can tell, Balaji Srivasanan introduced the Idea Maze in [his Stanford Startup Course](https://spark-public.s3.amazonaws.com/startup/lecture_slides/lecture5-market-wireframing-design.pdf) and Chris Dixon made it well known [on his blog](https://cdixon.org/2013/08/04/the-idea-maze).

[^fn7]: \<sidenote\> [Generally, things are done the way they are for a reason. ](https://en.wikipedia.org/wiki/G._K._Chesterton#Chesterton's_fence)

[^fn8]: Both the terms 'innovation' and 'innovation ecosystem' are often frustrating [suitcase word](https://alexvermeer.com/unpacking-suitcase-words/)s. But it is useful to have a shorthand for "all the institutions that enable activities that collectively cover the process of an idea becoming a new impactful idea or technology."

[^fn9]: Long-term roughly translates to more than \~five years.
...
[^fn13]: Yes, it's a much less catchy question. And in this particular case the book does delve into the institutional constraints; many people do not.

[^fn14]: \<sidenote\> For more on breakdowns on the Scientific Process, I recommend[ Brian Nosek's work on the replication crisis](https://www.nature.com/news/over-half-of-psychology-studies-fail-reproducibility-test-1.18248) or Stuart Ritchie's book [Science Fictions](https://www.sciencefictions.org/)
...
[^fn18]: \<sidenote\> For more about why industrial labs started see [The Changing Structure of American Innovation](https://static1.squarespace.com/static/593d9b08be65945a2e878544/t/5d31ac9b33ae9b0001d88216/1563536539717/c14259.pdf) - Some Cautionary Remarks for Economic Growth

[^fn19]: \<sidenote\> [Pasteur's Quadrant ](https://www.amazon.com/Pasteurs-Quadrant-Science-Technological-Innovation/dp/0815781776/ref=sr_1_1?crid=21T2ZKWPUWG0F&dchild=1&keywords=pasteur's+quadrant&qid=1613146396&sprefix=usb-c+to+mic,aps,206&sr=8-1)is an excellent exploration into the nuances of different types of research.

[^fn20]: Invoking Cunningham's Law, I will say this very aggressively in the hopes that I am wrong.

[^fn21]: This idea might be a fallacy. Arguably there is no platonic "ultimate stage" of a technology and whatever a technology evolves into is indelibly touched by the different specialized forms it needed to pass through.

[^fn22]: \<sidenote\>More abstractly, general purpose technology needs developmental *slack.* See [Studies on Slack.  ](https://slatestarcodex.com/2020/05/12/studies-on-slack/)
...
[^fn26]: This is a made-up term inspired by Surely You're Joking Mr. Feynman: "It was effortless. It was easy to play with these things. It was like uncorking a bottle: Everything flowed out effortlessly. I almost tried to resist it! There was no importance to what I was doing, but ultimately there was. The diagrams and the whole business that I got the Nobel Prize for came from that piddling around with the wobbling plate"

[^fn27]: \<sidenote\> For a good short article on the Valley of Death and its relationship to Technology Readiness Levels, see [Technology Readiness and the Valley of Death](https://www.boeing.com/features/innovation-quarterly/may2017/feature-thought-leadership-newman.page).

[^fn28]: Though this time period is probably longer than it would have been because it was interrupted by a world war.

[^fn29]: I will only touch on academia's constraints lightly here - only enough to draw the contrast to industrial labs. More on this later!

[^fn30]: It's worth spending more time thinking about the 'dimensions' of the valley of death - because it's not a matter of number of people as the "ramp" language here might imply.

[^fn31]: \<sidenote\> See eg. [Google X and the Science of Radical Creativity](https://www.theatlantic.com/magazine/archive/2017/11/x-google-moonshot-factory/540648/)

[^fn32]: Condition \#3 was originally "1+2 are insufficient if the technology the lab works on isn't tied into the company's core business." However, this isn't quite right. There are situations where technology work on the core product can have nothing to do with existential risks to the business (for example Salesforce.) Similarly there are situations where technology work has little to do with the core product but addresses an existential threat (for example flashy research at Bell Labs keeping regulators from breaking up the monopoly.)

[^fn33]: \<sidenote\> I'm using Knightian Uncertainty in its broader sense --- situations where there is not only uncertainty but you don't even know what the probability distribution is or even what axis to measure it on. 
	
	See [Risk, Uncertainty, and Profit](https://archive.org/details/riskuncertaintyp00knigrich).

[^fn34]: Some people use the term money fountain - I think this makes it sound a bit too magical. Money factories are mystical enough.

[^fn35]: Figuring out how to develop technology faster is so impactful because it breaks this initial assumption and weakens the dependence on a money factory. At the same time, technology R+D+Diffusion timescales seem weirdly robust, so the burden of proof is on anyone who claims to have sped up the process.

[^fn36]: There is, of course, an entire literature about projects like this going drastically over budget and timeline.

[^fn37]: Although better program design could help!

[^fn38]: It would be fascinating if someone did a study on the full two-by-two: situations where expectations of success helped a project, hurt that project and where expectations of failure did the same.

[^fn39]: \<sidenote\>See [Finite and Infinite Games](https://www.goodreads.com/book/show/189989.Finite_and_Infinite_Games)

[^fn40]: I suspect these arguments apply to innovation organizations in general but I want to narrow the scope here a bit to just research organizations

[^fn41]: Or at least be perceived to be addressing existential threats - there are many organizations that successfully maintain funding based purely on great marketing. It's worth paying attention to why this marketing works but I'm going to otherwise ignore it because I am bad at pulling off false pretenses and would prefer if the world had fewer of them.

[^fn42]: \<sidenote\> The book [Loonshots](https://www.goodreads.com/book/show/39863447-loonshots) introduces the  concepts of "warty babies" and "the three deaths" which are incisive mental models of the phenomena that lead to project-cradle-death.

[^fn43]: This is very true of 1960's ARPA but less so of DARPA. Over time, congress has exerted more direct oversight over DARPA programs. That being said, there's still less overhead than other government research.

[^fn44]: It's unclear whether it they should even be called labs!

[^fn45]: Lockheed Martin is supposedly working on a portable fusion reactor,

[^fn46]: \<sidenote\> The memo is quite good and [available here](https://xconomy.com/national/2013/10/01/microsoft-research-memo-analysis/).

[^fn47]: \<sidenote\> For more on the first case, see the section in [Loonshots](https://www.goodreads.com/book/show/39863447-loonshots) about "Manage the transfer, not the technology" and for the second, see "Separate soldiers and scientists" (Have I convinced you to read it yet?)

[^fn48]: \<sidenote\> See [Killing the Golden Goose? The changing nature of corporate research](https://faculty.fuqua.duke.edu/~sb135/sb135/Science%201%2091%2015.pdf), 1980-2007 for an in-depth exploration of this trend.

[^fn49]: Before you write me an angry email, I am not saying that all teams at all industrial labs are now C players, but it is undeniable that most people *on the academic track* don't view industrial labs as a first-class alternative to universities.
...
[^fn53]: Maybe it's a Seattle thing?

[^fn54]: \<sidenote\> See [OpenAI forms exclusive computing partnership with Microsoft to build new Azure AI supercomputing technologies](https://news.microsoft.com/2019/07/22/openai-forms-exclusive-computing-partnership-with-microsoft-to-build-new-azure-ai-supercomputing-technologies/#:~:text=The%20partnership%20covers%20the%20following,promise%20of%20artificial%20general%20intelligence)
...
[^fn61]: \<sidenote\> See [The decline of science in corporate R&D](https://onlinelibrary.wiley.com/doi/abs/10.1002/smj.2693) again

[^fn62]: Broadly including institutions in theier ecosystems like venture capital, incubators, national research centers

[^fn63]: There are many others!

[^fn64]: \<sidenote\> See <http://worrydream.com/LadderOfAbstraction/>

[^fn65]: In fact, it would be accurate to draw an arrow from the bottom of engineering design to the bottom of scientific inquiry and do the same from the top of scientific inquiry to the top of engineering design, creating an ouroboros: The mythical snake eating its own tail

[^fn66]: \<sidenote\> See <https://benjaminreinhardt.com/trl>

[^fn67]: This can of course happen outside of academia! But in academia it can go forever without running into the cold hard wall that is reality.

[^fn68]: And through self-reinforcing cultural evolution.

[^fn69]: See especially: any graduate work that involves culturing cells or working with equipment that is more than thirty years old.

[^fn70]: \<sidenote\> See [*Paper Authorship Goes Hyper*](https://www.natureindex.com/news-blog/paper-authorship-goes-hyper)
...
[^fn74]: \<sidenote\> I want to use the term "antedisciplinary science" from [Sean R. Eddy's article of the same name](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.0010006) but relegated it to this footnote to avoid too many new words.

[^fn75]: Despite the fact that there is an increasingly wide gap between the number of graduate students training for PhDs and academic positions for them to fill!

[^fn76]: \<sidenote\> <http://paulgraham.com/growth.html>

[^fn77]: There will always be exceptions!

[^fn78]: \<sidenote\>"We conclude that only a miniscule fraction of the social returns from technological advances over the 1948-2001 was captured by producers" - from [Schumpeterian Profits in the American Economy - Theory and Measurement](https://www.nber.org/system/files/working_papers/w10433/w10433.pdf)

[^fn79]: \<sidenote\> See [Fundamental Manufacturing Process Innovation Changes the World](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3470660)

[^fn80]: \<sidenote\> In addition Jerry Neumann argues convincingly in that VCs rationally should avoid technical risk in [Productive Uncertainty](http://reactionwheel.net/2020/11/productive-uncertainty.html)

[^fn81]: Basically the entire world is a monetized economy as of the early 21st century. There is a whole other rabbit hole about the goodness or badness of that fact but I'm going to avoid that discussion and just treat a monetized economy as a given.

[^fn82]: This is not a new phenomenon. Newton spent the last decades of his life working at the British Mint instead of doing physics.

[^fn83]: Shannon made a killing on the stock market, but as far as anybody knows, he didn't use information theory to do it.

[^fn84]: \<sidenote\> See [The Data of Long-lived Institutions](https://blog.longnow.org/02020/10/21/the-data-of-long-lived-institutions/)

[^fn85]: \<sidenote\> Jason Crawford [argues that cash-flow also creates the tightest possible feedback loop with the world outside the organization.](https://rootsofprogress.org/organizational-metabolism-and-the-for-profit-advantage)
...
[^fn89]: \<sidenote\> [The Mother of All Demos](https://en.wikipedia.org/wiki/The_Mother_of_All_Demos) was Douglas Engelbart's tour-de-force where he demonstrated the majority of what has become modern computing in 1968.

[^fn90]: \<Sidenote\> See[ Scientific Knowledge as a Global Public Good - Contributions to Innovation and the Economy](https://www.ncbi.nlm.nih.gov/books/NBK221876/).

[^fn91]: I am not a lawyer, this is not legal advice.

[^fn92]: The Wright Brothers famously spent a lot of time litigating patents.

[^fn93]: Charles Goodyear - one of the inventors of vulcanized rubber lost a series of court cases and made little money from his invention.

[^fn94]: If the technology is modular enough that it can easily be sold and incorporated into many other products, it's still just a product.
...
[^fn98]: \<sidenote\> See [Congressional Tribute to Dr. Norman E. Borlaug Act of 2006 ](https://www.govinfo.gov/content/pkg/PLAW-109publ395/html/PLAW-109publ395.htm)

[^fn99]: I'm going to just talk about patents but the same arguments apply to both

[^fn100]: This is two orders of magnitude larger than US population growth.

[^fn101]: \<sidenote\> See [Age of Invention: How to Build a State](https://antonhowes.substack.com/p/age-of-invention-how-to-build-a-state)

[^fn102]: \<sidenote\> For a much deeper discussion about where patents are helpful or harmful see [The Patent Crisis and How the Courts Can Solve It](https://www.goodreads.com/book/show/6885496-the-patent-crisis-and-how-the-courts-can-solve-it)

[^fn103]: \<sidenote\> '[Heuretic' is a better word](https://twitter.com/antonhowes/status/1252638141577662482), but I've introduced enough new terms as it is.

[^fn104]: \<sidenote\> This section only skims the surface of this topic as far as we need to understand the sorts of technologies that current institutions have trouble enabling. For a much deeper dive see the already-mentioned-but-worth-mentioning-again [The Patent Crisis and How the Courts Can Solve It](https://www.goodreads.com/book/show/6885496-the-patent-crisis-and-how-the-courts-can-solve-it)

[^fn105]: \<sidenote\> See [The Nature of Technology:What it is and How It Evolves](https://www.goodreads.com/book/show/6321234-the-nature-of-technology) and [One Process](http://reactionwheel.net/2020/04/one-process.html)

[^fn106]: Composability is an excellent and under discussed concept. <https://en.wikipedia.org/wiki/Composability>

[^fn107]: It was (and still is) a giant cost and pain.

[^fn108]: In the sense of ['charismatic megafauna'](https://en.wikipedia.org/wiki/Charismatic_megafauna)

[^fn109]: See <https://en.wikipedia.org/wiki/Wright_brothers_patent_war>

[^fn110]: \<sidenote\>There literally is an academic argument over this. For arguments that patent thickets did stifle airplane development see [Spillover Effects of Intellectual Property Protection in the Interwar Aircraft Industry](https://academic.oup.com/icc/article-abstract/24/1/1/824074) and for arguments that patents weren't a problem see [The myth of the early aviation patent hold-up---how a US government monopsony commandeered pioneer airplane patents](https://academic.oup.com/icc/article-abstract/24/1/1/824074). I find the former compelling but it's tricky.

[^fn111]: \<sidenote\> See [Not Counting Chemistry: How We Misread the History of 20th-Century Science and Technology  ](https://www.sciencehistory.org/distillations/not-counting-chemistry-how-we-misread-the-history-of-20th-century-science-and)

[^fn112]: \<sidenote\> See [The Decline of Science in Corporate R&D](https://onlinelibrary.wiley.com/doi/abs/10.1002/smj.2693) (again)

[^fn113]: \<sidenote\> See [This Interview with Alan Kay](https://juxt.pro/blog/alan-kay)

[^fn114]: The equivalent of suing someone who isn't paying the licensing fees on a patent.

[^fn115]: \<sidenote\> See [A Brief History of the Corporate Form and Why it Matters](https://news.law.fordham.edu/jcfl/2018/11/18/a-brief-history-of-the-corporate-form-and-why-it-matters/)

[^fn116]: \<sidenote\> See [The Modern Corporation and Private Property](http://www.goodreads.com/book/show/781883.The_Modern_Corporation_and_Private_Property).

[^fn117]: Note that this isn't a good or a bad thing - while the default reaction at least in Silicon Valley circles is that it is.

[^fn118]: Although cognitive-dissonance-introducingly there are nonprofits that make a large profit in everything but the legal sense, and for-profits that don't seek to maximize profits at all.

[^fn119]: \<sidenote\>From [VC Funds 101: Understanding Venture Fund Structures, Team Compensation, Fund Metrics and Reporting \| by Ahmad Takatkah \| VCpreneur](https://vcpreneur.com/vc-funds-101-understanding-venture-fund-structures-team-compensation-fund-metrics-and-reporting-152b02e8504a)

[^fn120]: Less-used tax designations vary both over space and time like S-corps or Benefit Corps. For example, as of late 2020, benefit corporations are authorized in 35/50 US states. They exist in some states but not in other states and are legislated into existence and sometimes out of existence.
...
[^fn124]: \<sidenote\> See <https://openai.com/blog/openai-lp/>

[^fn125]: One could argue how much of this is just talk, but I default to trust and it helps argue my point.

[^fn126]: Former PMs are still (understandably) hesitant to talk about could-have-been program ideas.

[^fn127]: \<sidenote\> See for example the history of DARPA's drone program in [The DARPA Model for Transformative Technologies: Perspectives on the U.S. Defense Advanced Research Projects Agency](https://www.openbookpublishers.com/product/1079)

[^fn128]: \<sidenote\> See [A new UK research funding agency](https://committees.parliament.uk/publications/4665/documents/47032/default/)
...
[^fn132]: \<sidenote\> See the [Room for Improvement section of Why Does DARPA Work?](https://benjaminreinhardt.com/wddw#room_for_improvement)

[^fn133]: I like to think of this like how polynomial approximations are valid in a local area around an equilibrium.

[^fn134]: There are few things more fun to talk about than how messed up your old company was.

[^fn135]: These people should not visit climbing gyms.

[^fn136]: \<sidenote\>The University of Utah CS department is notorious for early computer graphics work like the [Utah Teapot](https://en.wikipedia.org/wiki/Utah_teapot). Pixar Founder Ed Catmul is a direct descendent of this tradition.

[^fn137]: There's not a great word for these people. "End-users" sounds incredibly clinical and alternatives like "consumers" invokes large numbers of unsophisticated people.

[^fn138]: (Who/which member of an organization is actually spending the money? Who do you need to convince that it's a good idea? How does the customer know it works? What does the contract look like? Do you need to go through a third party? These are of course questions for any product (and invite innovation!) but more established types of products have more standard answers.

[^fn139]: Obviously there is much more haggling involved but it is a much more straightforward conversation for both sides.

[^fn140]: This word also feels insufficient, but is the commonly-used word for "getting technology to end-users." I'm going to be a bit sloppy and jump between "selling" and "diffusing."

[^fn141]: \<sidenote\> See the [NVCA 2017 Yearbook](http://nvca.org/nvca-2017-yearbook-go-resource-venture-ecosystem/)

[^fn142]: At least at the program level.

[^fn143]: \<sidenote\> See the section [DARPA uses low-stakes seedling programs to 'acid test' the riskiest part of a program idea](https://benjaminreinhardt.com/wddw#darpa_pms_use_seedling_projects_to_%E2%80%98acid_test%E2%80%99_the_riskiest_pieces_of_a_program_idea) from Why Does DARPA Work?

[^fn144]: To paint the counterfactual of explicitly making sure experiments have no negative consequences: One could imagine that after a failed seedling experiment a PM could implicitly or explicitly need to 'redeem' themselves by going above and beyond. Similarly, the organizational attitude towards a performer who ran a failed experiment might implicitly shift towards "well they're good people but a bit incompetent."

[^fn145]: As opposed to something like flossing where people are like "yeah I really should be doing that ... later."

[^fn146]: This is an example of the more general principle that optimizing individual components of a system is often at odds with the system itself.

[^fn147]: \<sidenote\>In chemistry, [free radicals are atoms, molecules, or ions with an unpaired valence electron that makes them extremely reactive.](https://en.wikipedia.org/wiki/Radical_(chemistry))

[^fn148]: \<sidenote\> See [The Idea Factory](https://www.goodreads.com/book/show/11797471-the-idea-factory) again.

[^fn149]: \<sidenote\> See the section [A large part of a DARPA program manager's job is focused network building](https://benjaminreinhardt.com/wddw#a_large_part_of_a_darpa_program_manager%E2%80%99s_job_is_focused_network_building) from Why Does DARPA Work?

[^fn150]: \<sidenote\> From The Idea Factory again.

[^fn151]: \<sidenote\> See [Fundamental Manufacturing Process Innovation Changes the World](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3470660).

[^fn152]: \<sidenote\>The term 'Relationships' is usually a [suitcase handle word ](https://notes.benjaminreinhardt.com/Suitcase_Handle_Word)so I'm going to strive to be as specific as possible here

[^fn153]: Ack! So many suitcase words!

[^fn154]: It's jumping ahead a bit but This is a key reason why it's important to a replicable institutional model.
...
[^fn158]: Peter van Hardenberg poetically names this an organization's "Reaper function."

[^fn159]: Though of course circumstances could have changed to make this no longer true.
...
[^fn169]: \<sidenote\> See the section [Most DARPA clones start too big or with heavy process](https://benjaminreinhardt.com/wddw#most_darpa_clones_start_too_big_or_with_heavy_process) from Why Does DARPA Work?

[^fn170]: \<sidenote\> See [DARPA---Enabling Technical Innovation](https://www.openbookpublishers.com/htmlreader/978-1-78374-791-7/ch10.xhtml)

[^fn171]: \<sidenote\> See [numbers appendix](https://docs.google.com/spreadsheets/d/1urHWgKDozpdsJDpV1fFcO_jZMVWFl5FEdg31pr42UGU/edit?usp=sharing).

[^fn172]: \<sidenote\> See [Department of Defense Fiscal Year (FY) 2020 Budget Estimates](https://www.darpa.mil/attachments/DARPA_FY20_Presidents_Budget_Request.pdf) and [in spreadsheet form here](https://docs.google.com/spreadsheets/d/1qw3_A2P6y4rj-h_ailqoRdMFBmgwhN2ne2Ivk5lHwd8/edit?usp=sharing)
...
[^fn176]: \<sidenote\> See [Canada needs a national overhaul of university IP policies](https://www.universityaffairs.ca/opinion/in-my-opinion/canada-needs-national-overhaul-university-ip-policies/)

[^fn177]: \<sidenote\> For more on Deep Science Ventures and Tandemlaunch see Episodes [19](https://ideamachinespodcast.com/mark-hammond) and [30](https://ideamachinespodcast.com/eleonora-vella) of the Idea Machines podcast respectively.

[^fn178]: \<sidenote\> See <https://www.intellectualventures.com/spinouts>

[^fn179]: It's worth noting that of these, only the Santa Fe institute does not have a large endowment.

[^fn180]: While not official, my understanding is that after struggling to find funding Dynamicland closed its doors in 2020 (in part due to COVID-19 but that was only final nail.)

[^fn181]: "When a measure becomes a target, it ceases to be a good measure"

[^fn182]: Charities can't lock in commitments the way for-profit funds can

[^fn183]: 'Small' here is \<2% of total funding

[^fn184]: \<sidenote\> [Howstuffworks has a reasonable explainer](https://money.howstuffworks.com/economics/volunteer/starting-a-charity/rules-charities-follow.htm)

[^fn185]: \<sidenote\> See the section [Opacity is important to DARPA's outlier success](https://benjaminreinhardt.com/wddw#opacity_is_important_to_darpa%E2%80%99s_outlier_success) from Why Does DARPA Work?

[^fn186]: Foundations are legally required to disburse at least 5% of their assets towards their charitable mission every year.

[^fn187]: Legally, foundations aren't allowed to make 'excessively risky investments.'

[^fn188]: Are you starting to see why all these legal shenanigans matter?
...
[^fn192]: \<sidenote\> For a more in-depth flowchart of the different ways PRIs can happen based on different constraints see [Foundations: exploring the emerging practice of philanthropic investing to support innovation in science and engineering](https://primecoalition.org/wp-content/uploads/2018/03/MIT-Innovation-Initiative-Foundations-Final.pdf?x48191)

[^fn193]: \<sidenote\> See the section[ It is relatively easy for DARPA PMs to re-deploy funding](https://benjaminreinhardt.com/wddw#it_is_relatively_easy_for_darpa_pms_to_re-deploy_funding) from Why Does DARPA Work?

[^fn194]: Of course, members of a consortium are not automatically bought in to everything that comes out of it.

[^fn195]: Spoiler alert: Speculatively, this is a good idea!

[^fn196]: \<sidenote\> See [Reflections on 2020 as an Independent Researcher](https://andymatuschak.org/2020/) for a more in-depth description of this approach.
...
[^fn203]: Except for it's majority-internalized research DeepMind is basically an AI-focused DARPA-riff.
...
[^fn207]: "The best way to predict the future is to invent it" --- Alan Kay

[^fn208]: \<sidenote\> See [Department of Defense Fiscal Year (FY) 2020 Budget Estimates](https://www.darpa.mil/attachments/DARPA_FY20_Presidents_Budget_Request.pdf)

[^fn209]: \<sidenote\> See [The End of AT&T](https://spectrum.ieee.org/tech-history/dawn-of-electronics/the-end-of-att) (might require a free account login.)

[^fn210]: \<sidenote\> See [The making of American industrial research : science and business at GE and Bell 1876-1926](https://www.goodreads.com/book/show/4533514-the-making-of-american-industrial-research?ac=1&from_search=true&qid=dS5KvCWvTF&rank=1)

[^fn211]: \<sidenote\> See the list on wikipedia [here](https://en.wikipedia.org/wiki/List_of_colleges_and_universities_in_the_United_States_by_endowment)

[^fn212]: \<sidenote\> See [HHMI Financials](https://www.hhmi.org/about/financials)

[^fn213]: Contra an 'impossible' situation where the number came out bigger than the market capitalization of Amazon, for example.

[^fn214]: \<sidenote\> See [What makes DARPA tick](https://science.sciencemag.org/content/351/6273/549)
