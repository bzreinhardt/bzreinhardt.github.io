...
Money-factory-alignment provides a lens through which we can both notice that great labs required a trifecta of conditions and understanding why atom-focused industrial labs no longer fill the niche they once did. These three conditions for great labs were: 
...
4. It's possible for this entire cycle to eventually become self-catalyzing
    ...
    15. "Pseudo-self-catalyzation" is state where the organization is getting enough consistent revenue through some combination of donations, spinoffs, and other sources like licensing and consulting that it can continue to run multiple programs assuming those revenue sources continue.
...
One cluster where things could be better is what I might call "breakdowns in the scientific process." Here you see issues like the replication crisis and science being judged not on one of several scientific epistemologies, but on politics and its ilk. [^fn15]
...
3\. **Personal Computers** **---** nobody was asking for most of the pieces of the Mother of All Demos[^fn91]. Instead of collaborative shopping lists and voice calls, the military wanted a computer that could help commanders understand what was happening with nukes and battles.
...
Knowledge is non-rivalrous. Your knowledge of airplane building does not prevent me from knowing how to build an airplane. Once knowledge is no longer secret, it generally becomes non-excludable as well. As a result, a lot of research resembles a public good.[^fn92]
...
The direct ways to capture the value from research are to patent[^fn101] it or build a product around it (and leverage trade secrets.) Other possibilities are more indirect and 'credit based': consulting, speaking fees, or leveraging reputation to get more lucrative positions later.
...
It's worth noting two historical facts about patents that shed some light on their limitations. Patents have gone from well-reviewed descriptions of already-built mechanical inventions to hastily-reviewed descriptions of everything from software to biotech written by lawyers. The number of patents issued in the US has increased by four orders of magnitude since the patent office opened --- from 33 in 1791 to 354,430 in 2019.[^fn102] The number of patent reviewers hasn't increased anywhere near that much. On top of all of that, patents weren't even created as a value-capture tool for discovery or invention. Instead, patents started as a way for monarchs to increase their income without going through Parliament by granting temporary monopolies.[^fn103] Of course, the modern patent system is explicitly meant to incentivize innovation so this might be nothing more than a historical anecdote.
...
"But unique new technology creates a moat that will make the company successful!" Jerry Neuman's Productive Uncertainty[^fn104] argues convincingly against pure-technology with the idea of "excess value" an invention would produce for a startup.
...
This combinatorial drag from patents is why In most industries outside of pharma and chemicals, patents are a net drag on innovation.[^fn105] Chemicals and drugs usually have a 1:1 correspondence between patents and products. On the other hand, semiconductors and software can have dozens of patents in a single product.
...
2. To avoid introducing a new term I'll be using the term 'creation' to describe nebulous discovery/invention/potential innovation type things. [^fn106]
...
The innovation ecosystem of the late 19^th^ and early 20^th^ century is one of the strongest pieces of evidence that private innovations alone can carry the torch of progress forward. It was an age of massive technological change --- vulcanized rubber! Automobiles! Airplanes! Electricity! Telephones!   Almost all created by private for-profit companies, patented, and sold.

However, many of these innovations only hit the mainstream when the component technologies became public knowledge. There was an explosion of car patents in the 1880's and 1890's and an explosion of car *production* in the 1900's and 1910's, roughly tracking the end of a patent's 20 year lifespan. It's telling that safety glass was patented in 1905 and became standard car equipment in 1926. Of course, this could be completely correlational and the time gap between invention and diffusion is just how much time was needed for learning-by-doing to happen. 

None of these technologies were complex enough that you couldn't figure out how it works by taking it apart. Nor did they require up-front capital costs inaccessible to individuals without institutional backing. Those attributes mean that almost by default the technologies became public knowledge as soon as they were sold. The sufficiently low cost and complexity combined with the cost of acquiring and enforcing patents in multiple countries at once[^fn110] meant that while private, for-profit organizations were creating the technology, the technology itself was effectively public. It was virtually impossible for a single organization to blunt its impact across the whole world. The t

Many of the 'charismatic'[^fn111] technologies of the late 19^th^ century were 'final goods' with relatively small functional surface area. Cars move you and your stuff fast, telephones let you talk to someone else, airplanes move stuff through the air. Even electricity was primarily just used to light stuff up and spin things. Additionally, you could make these technologies good enough to have *some* market using relatively low-complexity component parts that could be created in-house. In situations where those component parts were private thanks to patents or just secrets, the invention's impact was suppressed until the components became more public. The canonical example is the Wright brothers' patent on coupled wing-warping/rudder control for airplanes[^fn112] which arguably[^fn113] stunted the American airplane industry for a decade.
...
Historically, new legal structures have enabled new classes of activity. The creation of joint stock companies in the 1600's enabled larger and riskier private ventures like the East India Company[^fn118] and arguably enabled a lot of English settlement in North America. The creation of limited liability corporations in the mid 19th century helped enable the railroad boom first in Britain and then in the US.[^fn119] In 2020, SPACs made going public a reasonable move for several non-software technology companies that may not have happened otherwise.
...
![][vc_fund_structure]The structure of a typical VC firm[^fn122]

At the end of the day legal structures are "just" contracts that determine how money flows and how decisions are made both within and between one or more taxable entities. We generally think of organizations in terms of these tax designations: LLC, C-Corp, 501(c)(3), etc.[^fn123] Our custom of using tax designation as one of the primary descriptions of an organization hints at the fact that taxes matter a lot! Tax designations can place requirements on organizational structure like the need for a board of directors and determine both what happens to money that comes in (eg. C-corps and their shareholders are both taxed, only the shareholders of an LLC are taxed) and what an organization is allowed to spend money on (eg. 501(c)(3)s can only spend money related to their official mission).
...
OpenAI's capped-profit/nonprofit structure [^fn127]is a great example of an organization playing with legal structures to match their own situation and shape incentives in ways that wouldn't otherwise be possible. They need to be able to pay AI researchers top dollar, while at the same time their nominal mission is to keep powerful AI technology from being captured by organizations whose incentives are to use it to maximize shareholder value.[^fn128]
...
In addition to establishing the fact that it *is* possible to riff on the DARPA model[^fn131] it's also important to ask whether that riff can exist outside of a government. Is it only possible to riff on the DARPA model successfully with organizations like [IARPA](https://iarpa.gov) or the recently-announced British ARPA, ARIA[^fn132]?
...
* [DARPA Program managers pull control and risk away from both researchers and directors](https://benjaminreinhardt.com/wddw#darpa_program_managers_pull_control_and_risk_away_from_both_researchers_and_directors)
* [The best DARPA program managers are the ones who can look at an entire literature in an area and notice a systemic bias](https://benjaminreinhardt.com/wddw#the_best_darpa_program_managers_notice_systemic_biases)
* [DARPA is incredibly flexible with who it hires to be program managers](https://benjaminreinhardt.com/wddw#darpa_is_incredibly_flexible_with_who_it_hires_to_be_program_managers)
* [DARPA Program managers have a tenure of four to five years](https://benjaminreinhardt.com/wddw#darpa_program_managers_have_a_tenure_of_four_to_five_years)
* [Why do people become DARPA Program managers?](https://benjaminreinhardt.com/wddw#why_do_people_become_darpa_program_managers?)
* [A large part of a DARPA program manager's job is focused network building](https://benjaminreinhardt.com/wddw#a_large_part_of_a_darpa_program_manager%E2%80%99s_job_is_focused_network_building)
* [DARPA PMs need to think for themselves, be curious, and have low ego](https://benjaminreinhardt.com/wddw#darpa_pms_need_to_think_for_themselves,_be_curious,_and_have_low_ego)
* [The dependence of DARPA on high quality program managers mirrors the obsession with "talent" in other disciplines](https://benjaminreinhardt.com/wddw#at_the_end_of_the_day_the_arpa_model_depends_on_badass_program_managers_which_mirrors_the_obsession_with_%E2%80%9Ctalent%E2%80%9D_in_other_disciplines)
...
DARPA uses low-stakes seedling programs to 'acid test' the riskiest part of a program idea. [^fn147]There's no reason that a DARPA-riff can't shamelessly copy that strategy directly.  The trick is to go into them with the explicit attitude "let's see what will happen." It's important to acknowledge that while everyone would rather seedlings lead to a promising program than be a nothingburger, reality might have different plans. The way to prevent that preference from morphing into pressure is to explicitly make sure that negative results don't have lasting effects. Specifically, negative results absolutely cannot affect a program manager's ability to run other experiments or affect an external researcher's relationship with the organization as a whole.[^fn148]

It's tempting to ask "why do you need a DARPA-like organization at all? Just run each program separately." An organizational umbrella over programs can turn targeted piddling around into a compounding long-term benefit.[^fn149] The results of piddling around often come in the form of informative failures or tacit knowledge. It's easy for these results of piddling around to evaporate. If each program was a separate organization, pursuing any serendipitous discovery that didn't help the program move towards its goals would be a distraction. Someone might keep track of those discoveries but there would be relatively little incentive to do so.[^fn150] An umbrella structure can enable serendipitous potential side-quests discovered during the main body of a program to be fed back to the beginning of the "pipeline" and possibly become its own program.

A DARPA-riff could also enable targeted piddling around by explicitly having people whose job is to piddle around! These 'free radicals'[^fn151] could be competent individuals who aren't attached to any specific project. They could help PMs design programs, do experiments, or research areas that nobody in the organization has even thought about. You could imagine this role as having the flavor of a 'pre-PM \<X\>-in-residence.' The role would resemble an internship in the sense that the radical isn't doing anything mission-critical and could potentially become a PM but without the expectation of that outcome. The role would be unlike an internship because it would involve much more independence and there would be less of a teaching component --- people in the role would already be skilled. It also rhymes with the constant theme in Bell Labs narratives where 'free radicals' between projects would play a critical role in everything from semiconductor manufacturing techniques to solar cells.[^fn152] However, this sort of role would need to be defended: it's anathema to efficiency and could easily be a waste of resources! 

**3\. Industrial labs enabled high-collaboration research work among larger and more diverse groups of people than in academia or startups.**

A DARPA-riff can be a bridge between different worlds and disciplines. Seedling programs enable PMs to slowly pull together a diverse set of performers by holding regular closed-door meetings (so people can talk about real problems instead of just showing off good results) and making sure different performers know each other.[^fn153] J.C.R. Licklider was a master of this --- not only having regular meetings for PIs working on different aspects of interactive computing but for the graduate students working on it at well. A DARPA-riff can further enhance these collaborations if it explicitly pulls people together into a single organization as the program progresses.

Interactions between the program managers could be a high-collaboration between wildly different disciplines. Program managers can and should be drawn from a wide range of professional and technical experience. This diversity, combined with correctly set cultural expectations could go a long way towards filling this aspect of the niche. For example, at Bell Labs "They were not to work with their doors closed. They were not to refuse help to a colleague, regardless of his rank or department, when it might be necessary." [^fn154]
...
Externalized research is a load-bearing component of the DARPA model [^fn170]because it enables minimal full-time staff, spinning up or spinning down projects quickly, access rare talents and machines, and tying different approaches in parallel. However, not only is [it hard to capture value from research][It is hard to capture value from research], it is especially hard to capture value from externalized research!

The role of DARPA as a in-between organization [^fn171]that acts as glue for a broader innovation ecosystem feels weirdly important. That role also plays awkwardly with value capture.  If the whole goal is to kick off a *community*[^fn172], many entities need to feel like they can capture value from an innovation and might feel threatened or hesitate to collaborate with a purely for-profit venture.

## Is there a minimum effective budget to generate outlier results ##

[It is important for big things to start small][] --- many attempts to replicate DARPA's results start too big[^fn173]. So it makes sense to ask: is there a minimum effective budget to generate outlier results? Can you start with a tenth of DARPA's budget? A hundredth? A thousandth?
...
A back of the envelope calculation suggests that if each program generously has a 10% chance of success (DARPA has a 5-10% program success rate)[^fn174] then you need to run at least seven programs to give yourself a 50% chance of at least one program being successful[^fn175]. Whether these programs are run in series or parallel depends on available funding. However, if it takes five years to run a full program, running them in series could take a decade or more (assuming several unsuccessful programs are terminated early) to even demonstrate organizational feasibility. And this isn't "ten years to a $1B IPO" --- it's "ten years to getting a really promising technology out into the world that given another decade might produce a measurable impact." Given the absurd timeline of running programs in series, running several programs in parallel is important. The necessity of both starting small and running several programs in parallel to even demonstrate feasibility is one of the core tensions inherent in riffing on DARPA.

The question of minimum program budgets is tricky. Let's first look at some comparison numbers. In the years 2018-2020 among DARPA programs not focused on assembly and production, the minimum budget was $2m, the maximum budget was $31.4m and the average budget was $12m.[^fn176] The ARPA IPTO directorate that midwifed the personal computer started with a budget of $(2020)47M in 1962[^fn177].[^fn178] ARPA-E vacillates between \~$200-$300M/year, has about 50 programs running at any time, which comes out to roughly $4m to $6m per program. IARPA's budget is classified. Could a program go below a couple million dollars a year and still be effective? There are arguments both ways. On the one hand you could argue that surely bureaucratic inefficiency is pushing those budgets higher than they need to be. On the other hand, it might be that the sort of work that it's most valuable for a DARPA-riff to do needs a relatively large budget, otherwise it happen in other institutions. Without strong reasons to believe otherwise (which we don't have), it seems irresponsible to assume that you could run impactful programs for significantly less than DARPA. The saving grace is that programs don't need to start at full-budget but can ramp up over a year or two. 
...
A few organizations make a significant chunk of money from licensing revenue. Between 2008 and 2012 IBM made over $1B/year in licensing revenue.[^fn179] Intellectual Ventures' primary business model revolves around licensing. Universities are another example. [From an article on licensing revenues in 2015](https://www.latimes.com/local/education/la-me-uc-patents-20151011-story.html):
...
The many-small-donors end of the spectrum tends to push organizations towards either short-termism or constrained sizes. You'll notice that Charities that depend on many small donations are constantly asking for donations --- everybody has seen Wikipedia's yearly banner; and many of us remember asking for pennies for UNICEF on Halloween. Even if they aren't cash-strapped, Charities need to get 33% of their income from 'small donors'[^fn188] in order to maintain their legal status (and associated tax benefits for themselves and donors)[^fn189]. "Yeah, we're still struggling with the same experiments we were last year" is a common occurrence in research but isn't a great way to get people excited about donating, nudging charities towards shorter time horizons and flashier results. 
...
Given the issues with small donors and professionally managed Foundations, a common refrain is often: "Just find a few wise, long-term thinking billionaires and you're set!" This is lazy thinking for several reasons. 1) There are only 2095 billionaires in the world as of 2020. Being a billionaire doesn't shift your chances of being wise and long-term thinking too much 😱 so there just aren't that many wise, long-term thinking billionaires. 2) wise, long-term thinking billionaires already have a bajillion people banging down their door for money because everybody else has the same thought. 3) Partially as a result, many wise, long-term thinking billionaires have already bucketed their philanthropic dollars into a foundation 4) Being worth a billion dollars on paper doesn't mean that someone has a billion dollars in a bank account they can actually give away. 5) Perception of money isn't strictly a fraction of how much money you have --- tens of millions of dollars is a lot of money, period. 6) If a single person is bankrolling an entire project they (for good reason!) tend to feel some ownership over it. Depending on the person, this attitude may be problematic for an organization that benefits from opacity and independence.[^fn190] 7) A single source of funding means a single point of failure for the organization if the funder decides to pull out --- a not-uncommon occurrence. The upshot is not that it's a bad idea to consider funding from wealthy individuals but that it is a bad idea for that to be the only plan.
...
The advantage of government grants is that they come with relatively\*[^fn203] few strings attached. Governments don't care about either direct monetary ROI and can nominally act on long timescales. The government can actually capture value from public goods, so their incentives are nominally aligned[^fn204] with an organization whose goal is to create impactful technology. Governments also deploy a massive amount of money so the operating budget of a DARPA-riff isn't outrageous compared to other expenditures.
...
Arguably, [DeepMind](https://deepmind.com/) is a great example of the mitochondria maneuver.[^fn208] An AI research lab, they were acquired by Google in 2014 but unlike most acquired companies, they have maintained relative independence to do high-quality long-term work.[^fn209] As long as they continue to have hits every few years (AlphaGo, AlphaFold) and some of their work directly helps the mothership (some of their work makes Google's data centers more efficient) Alphabet seems willing to heavily subsidize their almost $1B budget. [^fn210]However, the fact that the Alphabet-DeepMind relationship meets the three criteria for healthy industrial labs should make you skeptical whether the mitochondria maneuver can be accomplished in other (lower-margin, less-clearly-aligned) domains. 

While they're under the same constraints in the long run, a key difference between a mitochondrial organization and a home-grown lab may be the ability to skate where the puck is going. A 'normal' industrial lab needs to justify its existence from day one --- 'stakeholder buy-in' and all that. By contrast, a mitochondrial organization only needs that justification *eventually.* DeepMind officially started in 2010 --- two years before AlexNet acted like lightning to AI hype's thunder. It's hard to put yourself in the mindset of pre-2012 attitudes towards AI research, but the term 'AI winter' exists for a reason. Suffice to say, it seems unlikely that any corporation would have created a full-fledged AI-focused lab in 2010. [^fn211]This framework suggests that a key requirement for the mitochondria maneuver to work is a strong thesis about how your DARPA-riff's focus will align with a high-margin corporation's priorities in the future.
...
Attempting the mitochondria maneuver seems fraught with failure modes. It basically requires predicting the future, which is hard. (Though easier if you're doing that by inventing it.) [^fn212]The steps an organization might need to take to survive might make it unpalatable for a corporation. The opposite could also happen! And while DeepMind has done well, history is littered with organizations that thought they were going to become their acquirer's R&D arm but the fates had other things in store for them. 
...
3. Convert into a non-profit focused on advancing the EPO's research mission if the EPO's research needs long-term research and coordination but won't be producing a product.
...
Program design is inextricably tied up with research planning. The idea of planning research might make some people throw up up in their mouths a little bit[^fn223], but bear with me. I'm going to put on my Wittgenstein hat[^fn224] and suggest that words matter; what people are actually objecting to is *scheduling* research around *deliverables*, which is very different from *planning* research around *goals*.
...
You could reasonably object to this analogy with a counter-analogy that the pieces of a research program are less like legos and more like biological components. Separate components in a biological process have much more 'agency' --- if you create the right environment and shake it or [apply a jolt of electricity](https://en.wikipedia.org/wiki/Miller%E2%80%93Urey_experiment), they will self-assemble. The biological analogy would be much more apt than a lego analogy if paradigm-shifting work cannot be planned or the innovation ecosystem is 'directionally' correct and just needs more funding and work along existing channels.
...
New technologies and disciplines are often 'good ideas' in theory but infeasible in practice because they're built on top of other technologies that aren't up to snuff. Electric cars that are comparable to gasoline-powered cars weren't really feasible until the electronics industry caused leaps in lithium-ion batteries. "Why now?" a good question to ask whenever someone proposes a new technology or discipline. A good answer can hint at eventual success. Of course, the many examples of successful creations that didn't have a particular "why now" means that while a bad answer to the question doesn't predict failure. Simulations may be an answer to the "why now" question for a new program design discipline: our capability to simulate everything from proteins to cities has exploded in the 21^st^ century and they have unique ability to precisely illustrate possibilities that do not yet exist in a way that is both internally consistent and externally consistent. 

Simulations have continuously improved over the late 20th century and early 21st century thanks to improvements in both software and hardware.[^fn237] Games and movies have pushed the edge of the possible, encouraging better algorithms, processes, and tools. Improvement in Graphics Processing Units (GPUs) both directly enable better simulations (the world is massively parallel!) and have fueled improvements in machine learning which has recently started unlocking simulation capabilities like AlphaFold and FermiNet.[^fn238]
...
## Employee-ownership could enable an ARPA-riff to align long-term incentives ##
...
My model of monetary compensation is that for most people[^fn241] it's not a strict matter of "more is better" but that there is a threshold that feels "fair" above which other incentives matter much more.
...
The most prominent way that organizations implement employee ownership is through the co-op model.[^fn242] As gross oversimplification: instead of a co-op having a management team who answers to a board, co-op employees *are* the management team and elect representatives who liase with the board. There's something emotionally appealing in the idea of a private DARPA as a 'research collective.' 
...
Technology diffusion inevitably depends on many other organizations: manufacturers, regulators, resellers, advertisers ... the list goes on. And people like to work with people they've worked with before. One big reason people tend to bet on industry insiders launching new ventures is because of the assumption that their existing relationships will reduce friction and make them more likely to succeed. At the same time, new technological paradigms often come from outsiders. What might look like a nefarious plot to suppress change[^fn243] can also be explained by outsiders not having the right relationships. 
...
I'm allowed to have one part of the speculation section that's just pure wild speculation, right? Ok here goes: It might be possible to create a SPAC[^fn244] that is designed to incentivize getting technology past a goalpost. 
...
In effect, an R&D Incentiviation SPAC (RDISPAC just rolls off the tongue right?) could act like a non-government advanced market commitment for a technology. Advanced market commitments are the government saying in effect "if you create something that meets these specifications, we guarantee we will buy N of them for $X apiece."[^fn245] The most famous advanced market commitment in recent memory is the US government's approach to COVID-19 vaccines. Of course an RDISPAC would differ from an advanced market commitment because investment doesn't automatically translate to customers the way an advanced market commitment does. 

The milestones that a SPAC is looking for would need to be very carefully considered. The best technologies don't always win, so there needs to be a strong argument that technical capabilities will translate into a long-term profitable business. Drug companies get around this problem because it's basically guaranteed that if you create a drug that gets FDA approval for a certain set of conditions, insurance companies will pay for it. However in any other case, new technology has bespoke sales channels. Instead of a fairly legible process, creating sales channels for something nobody has seen before requires almost-magical persuasion. One of the reasons why VCs (accurately) care so much about a startups founding team is because much of a company's success has nothing to do with the technology and everything to do with sales and market creation.[^fn246] It seems like an open question how to both argue that a technology-based SPAC is a good investment and have its acquisition conditions be based only on technical milestones. Additionally, the cash injection from the SPAC needs to be able to get the technology to a place where you're seeing fairly continuous business improvement. If the SPAC acquires a technology company and the share price falls, it's unlikely that you'll be able to raise any more money.

If we talk about it in terms of technology readiness levels[^fn247] (TRLs), an RDISPAC could target either 3 (proof-of-concept), 6 (prototype in a relevant environment), or 8 (production version in a real environment). If the RDISPAC were targeting TRL 3 or 6, the technology would actually skip being a VC funded startup. If the RDSPAC targeted TRL 8, you would still need to raise private funds and build a business but the existence of the SPAC (ie. A clear exit option) would hopefully make it easier to raise funds.
...
A striking throughline that connects ambitious and successful technology programs from SpaceX to PARC (and ARPA computing programs before that) is that they were organized either explicitly or implicitly around a *precise* vision of the future.[^fn248] These precise visions both act like a filter for likely-to-succeed programs and contribute directly to that success.
...
This litmus test doesn't limit you to just incremental changes either --- Vannevar Bush's essay As We May Think[^fn249] painted a precise vision of a thinking tool that was a massive paradigm shift away from anything that had existed before and yet precisely described many aspects of computers we'd recognize today. 
...
Most people don't advertise the fact that they want to go after slightly crazy research that requires resources or collaborators that aren't already at their disposal. This is doubly true if they actually have the skill to pull it off.[^fn253] There are exceptions of course, but most career-focused researchers file overly-ambitious ideas away 'for later.' Often these ideas are buried so deeply that they need prompting and trust to even talk about them out loud.[^fn254] 

A big part of the ICT's success depends on our ability to find these people. It will be a harder task than it might seem, especially without a track-record. While doing a few pieces of preliminary program design, I've found that the people who are excited about ambitious technical ideas often aren't in a position to execute on those ideas; either they don't have the technical expertise[^fn255] or because they're in a long-term position that precludes them doing the work. Conversely, the people who on paper are at the cutting edge of a field tend to have gotten there by being laser focused on a specific academic research agenda that can proceed methodically using the resources available to a single lab. This self-selected group is often distinctly unexcited by larger jumps that would involve combining their research with other disciplines. 

Not all hope is lost! I have come across several people who *do* seem to have a magical blend of technical skills and excitement about ambitious possibilities that might be one step beyond what is consensus possible. These people tend to be post-docs, grad students, and technically trained people who have left academia. So the 'right' people do exist --- [the challenge is to figure out how to find them *consistently* and bridge the gap between 'intrigued' and 'on board.'][It's possible to get people to undertake seedling experiments]
...
Work might not be able to get through a grant committee for several reasons: it doesn't fit into a neat bucket; it isn't directly related to research that the performer has done before[^fn256]; or it just doesn't have strong evidence that it will succeed. 
...
Some tactics that we can test to 'onboard' collaborators include: small workshops of high-potential possible performers; spending a lot of work building trust with individual researchers; [^fn257]working to build a long-term community that will continue to be valuable to researchers after any specific project. 
...
DARPA PMs use seedling projects to 'acid test' the riskiest pieces of a program idea.[^fn258] I'm confident that PARPA will be able to do something similar for our programs but it's still a hypothesis we need to explicitly test. It is extremely hard to call out in advance which pieces of evidence would compellingly suggest that a crazy idea is at least possible. 
...
Below are some top-of-mind examples[^fn259] of speculative seedling projects to prime your intuition pump. Binding constraints They might not be feasible for many reasons!
...
An obvious but important challenge is to bridge the gap between potential performers being 'interested' and actually taking action! How do we shift the people we found while testing the hypothesis that "[it's possible to find people...][It's possible to find people who want to do pieces of work that would not happen otherwise]" from talking to action? It's one thing to find people who have both the ambition and skills to undertake things and another to actually get them to spend the time undertaking them! 
...
It seems important for PARPA's initial programs to be relatively uncorrelated. Programs designed via the hub-and-spoke method by the same PM will be more strongly correlated with each other than via the workshop method. Early on, we won't have very many PMs, which suggests that 

While it's worthwhile to pursue both strategies, the potential pros of the workshop method and the potential downsides of the hub-and-spoke method
...
* The same '[tenuretrackless folks][The people who would want to do early program work tend to be post-docs, grad students, and technically trained people who have left academia]' who might make good performers may also make good PMs. Performers often become PMs at actual DARPA.
...
Spinning out[^fn263] as a company is only one of several ways that programs can 'graduate.' However it's worth talking about them directly because startups dominate so much of the cultural zeitgeist and potentially play a unique role in PARPA's business plans.  
...
While PARPA will hopefully be able to accomplish many important things, it will be structurally unable to do *all* the important things. Companies can conceivably[^fn265] monopolize an entire market and provide all the search, steel, cat videos, or diapers in the world. By contrast, DARPA's tiny and flat structure likely plays a key role in their success[^fn266] and any organization riffing on its model will see diminishing returns beyond its size.[^fn267] This may be similar to what you see in venture capital firms and many private equity firms --- small firms are able to get crazy returns on outlier results while large ones revert to the mean.
...
Contingent factors can always kill a given organization even if it gets the model correct. Or perhaps like ARDC[^fn268], arguably the first VC firm, you get the idea and some pieces correct but screw up others (like legal structures) in an ultimately fatal way.
...
However, while an aggregate of all of PARPA's activities will not be profitable, it's a reasonable (but still risky) hypothesis that a portfolio of companies spun out of PARPA could end up doing well. Regardless of profit, [PARPA will eventually spin out companies][] because companies can be an effective mechanism for technology diffusion. It's an even safer bet that if PARPA is doing something useful, there will end up being many profit-generating organizations that can trace their DNA back to PARPA. But let's ignore the latter for now.[^fn269]
...
In this form, PARPA will be just one or two full-time individuals designing possible programs. Remember, [it is important for big things to start small][It is important for big things to start small]! These PMs will be focused on an iterated process of 'hub-and-spoke' style work where an PMs reads many papers and talks to people many people to form their own hypotheses and couples that with [many-to-many workshops][Workshops are a systemized way of people-wrangling] where several experts come together to hash out possibilities. 
...
* A project to develop precise actuators for a DNA-based printer. Perhaps an expansion on William Shih's work. [^fn285]
* A project to develop protein building blocks (probably based on coiled-coil proteins[^fn286]1. that could be used in a DNA-based printer.
...
* A project to poke at how Metal Oxide Frameworks [^fn287]might play with the other projects.
* A project to look at how DNA/protein metal 'casting' [^fn288]might play with the other projects.
...
* *Shift ideas from outlandish to mundane*.[^fn289] Technological paradigm shifts don't come out of the blue. They are usually preceded by shifting Overton windows around what is impossible, what is feasible, and what is expected. These opinion shifts aren't necessarily causal so shifting opinion should not be a goal in and of itself but could be a useful leading indicator of doing good work.[^fn290] 
* *Produce useful ideas or artifacts that other organizations pick up and run with*. Creating convincing programs, prototypes, or system-seeds that other organizations pick up and run with is absolutely a leading success indicator. Andy Matuschak put it well: the goal is "developing ideas far enough that they become "obvious," the banal fodder for half a dozen companies in a future YC batch."[^fn291] There are traps to be aware of here as well --- in the same way that an acquired company's product is often quietly shut down, it's a real possibility that other organizations can claim to be pushing ideas or technology forward while quietly smothering it or completely mangling it.
...
* *Serve as a jumping-off point for eventually extremely impactful people.* History is full of largely-forgotten 'sceniuses'[^fn292] that quietly lie in the past of an uncanny number of impactful individuals. Creating a even a short-lived scenius, like the Rad Lab or Willow Garage would be a worthy result.
...
Organizational missions are a tricky thing. On the one hand, they can be an inspirational rallying point and a powerful discriminator between actions you should take and those you should forgo. On the other hand they can be a distracting pile of words that obscures reality and enables people to feel good about themselves without earning it.

Let's consider the question "[What makes a good organization mission][The boon and bane of institutional missions]?" with respect to PARPA. There's something immaculate about good organizational missions, as if they spring fully formed from someone's head. Unfortunately I'm not that good. Instead the most truthful (and hopefully interesting!) approach is to unpack the process. (This will also be a bit self-indulgent so forgive me.) If you don't want to ruin the magic, [you can skip to the conclusion.][Shifting Technology from Impossible to Inevitable]

## The Mission Thought Process ##

Here are the things I earnestly hope that the organization can accomplish, with no filters or fluff:

* Enable more amazing technology that feels like it's straight out of science fiction --- especially things that would be unlikely to happen otherwise.
* Help to fill one of the several gaping holes in the innovation ecosystem. Specifically the hole that exists around things that are too researchy for startups and too engineering heavy for academia.
* Provide a testbed for experiments in starting, managing, funding, and organizing R&D programs.
* Create a template for a replicable institutional structure.
* Have a sustained impact on the 21st and 22nd centuries that resembles the impact that Bell Labs and DARPA have had

To provide contrast, here's a tentative "out-of-scope" list. These points are supposed to be divisive and are *not* an assertion about the universal value of different focus areas:

* Longevity, Climate Change, and other 'hot' areas. While there are always opportunities to do different work there, it feels like it could too easily move from a non-zero-sum game to a competition with other organizations. It's fine to work on things that *incidentally* help - for example a massively better power source that *happens* to be carbon-free, or a massively better microscope that *happens* to be useful for longevity studies.
* Pure discovery work like unravelling the mysteries of the Big Bang or unifying quantum mechanics and general relativity. This sort of work is *extremely* important and needs new institutions to support it. But it is not solutions R&D. Of course, you often need to do discovery work in order to eventually invent something, so the line will be a bit nebulous.
* Human health in general. Health feels like an area that has oodles of attention and resources on it and requires a different approach than other solutions R&D. Also frankly I would rather live a short life with spaceships, antigravity, and replicators than an extremely long one with everything else unchanged.
* Pure software. Again, it feels like there is enough institutional support here.

It's extremely tricky to encode all of those points in a single sentence!

**Some Considerations**

Ideally the mission would capture a sense of wonder and exploration instead of feeling like a dry, sterile, or utilitarian thing.

I like the idea of somehow tying the mission to (Kuhnsian) paradigm shifts. You need to think very differently about 1.2x improvements and 10x improvements. 1.2x improvements can come from optimizing existing processes while 10x improvements often require fundamental process improvements.

Missions can be dangerous in research organizations. Missions can tempt you to focus on outcomes or impacts in a way that can strangle high-uncertainty projects in the cradle. If you say "we're only going after paradigm shifts" you could end up killing stupid little experiments of the sort that has led to paradigm shifts an uncomfortable number of times. So, perhaps focusing on paradigm shifts is ok if you are intellectually honest about how they happen.

It's tempting to look to something along the lines of "preventing technological stagnation" or "punching through the great stagnation" but I think that the mission should be oriented towards "creating good things" over "stopping bad things." And almost by definition if you are creating technological paradigm shifts you are fighting stagnation.

I also like the idea of focusing on human capability --- it keeps you grounded on the 'why' of the work. It also rules out a lot of knowledge-focused science, which would help satisfy the criteria that a mission should not be for everybody. 

My personal mission is simply to enable more awesome sci-fi shit. I'd like to find something similar for PARPA, but that isn't really an 'adult' mission. Is there a way to capture that gut-level discriminator I suspect we all have?

It'd be good to have something that makes it clear that simply inventing the technology is not good enough. Too many people create or fund a proof-of-concept, pat themselves on the back, and go home.

Another thought is to focus on the people *creating* the technology and emphasize being the place the people want to go as part of the mission - the thesis being if you can bring together and focus the right people, everything follows.

**Possibilities**

**Maximize our civilization's place on a The Culture Index**.[^fn294] This one raises the question "how could you frame this in terms of a mission that wouldn't lose people unnecessarily for being too nerdy?" The problem is that if you reference any single sci-fi concept specifically you get into an argument about it --- should it be the Star Trek Index instead? However, it does suggest a similar, Sci-fi independent mission ...

**Enable paradigm-shifting technology that pushes civilization higher on the Kardashev Scale**.[^fn295] This one might actually cover the things we care about but is both abstract and obscure. It would certainly turn off ergophobes.[^fn296] Perhaps there's an "explain it like I'm five" framing of the Kardashev scale. 🤔
...
**Generate quantum technology leaps** is accurate but too fuzzy.

**Create game-changing technologies in the core industries of human progress** is intriguing because it does push the organization towards important areas like manufacturing, energy, and agriculture but it feels meh and serious.

**Create technological surprise** or **Create technological surprise that moves civilization up the Kardeshev Scale.** "Creating technological surprise" is a riff on DARPA's mission to "Prevent technological surprise." I like this one because it rules out a lot of the things PARPA shouldn't work on --- specifically, ideas that are 'hot' (or at least the parts of them that people are already thinking about). It sets you up to specifically work on unexpected or unsexy things.
...
**Unleash creative technologists to render the world delightfully unrecognizable** This is the culmination of the people focus and unrecognizability focused line of thinking. A strong candidate.

**Predict the Future by Inventing It ---** Riffing off of the Alan Kay quote "The best way to predict the future is by inventing it." It is short and absolutely has the right tone but it doesn't do a good job narrowing anything down.

**Shift technology from impossible to inevitable** --- This one is short but does a lot of work. It actually outlines PARPA's modus operandi as an intermediate technology enabler. It secretly captures things that are too research focused for startups and too engineering heavy for academia: if a VCs goal is to invest in technology that is inevitable (but few people have realized it) who does the work to make it inevitable? Technological inevitability isn't a natural law. At the same time, Academia doesn't really care if something stays impossible forever, as long as it's well-studied. You get just a whiff of nerdy science fiction references by slightly invoking Clark's first and second laws (see below). Finally, the mission also explicitly acknowledges that we're trying to do something extremely hard!

On an entirely different thought-track, Clark's laws feel like a good place to mine for ideas. Let's riff on them:

**Experimentally verify Clark's First Law**[^fn297] is neat because it implicitly lays out an organizational plan of attack (find out what elder preeminent scientists say is possible and impossible!) But it's super obscure and not a great rallying cry.
...
**Build technology that is indistinguishable from magic ---** I like this because it hits on the wonder bit - perhaps we could incorporate more people-focus and change it to **Enable creative technologists to build technology that is indistinguishable from magic**. That captures the idea of a wide range of enabling activities, people focus, wonder, *and* we get a nerdy reference in there.

# Shifting Technology from Impossible to Inevitable #

We end our exploration of PARPA's idea maze at last. 

The maze exists in the first place because constraints on existing institutions have created a gap in the innovation ecosystem. 'Solutions R&D' was once the purview of industrial labs, but no longer. Shifts in both technology and how companies work mean that we can't expect Bell Labs' successor to look anything like Bell Labs. Nor can we count on the two institutions we've defaulted to in the 21^st^ century. Solutions R&D's tense mix of pragmatic application-focus and piddling around is too researchy for startups and too engineering heavy for academia. So, with a respectful hat-tip to Chesterton's fence, we need something new. 
...
Finally, I want to propose a specific path through the maze --- PARPA. We can look at PARPA[^fn298]'s potential path through the idea maze as a sequence of hypotheses --- junctures that decrease your risk of failing for each one you successfully pass. Bundled together, PARPA's path through the maze looks like:
...
I hope to have convinced you of several assertions 
...
* 21^st^ century DARPA-riffs need to exist outside of 21^st^ century government bureaucracies.
...
If however, you think the ideas I've presented are plausible, let's put them into action. There are so many things to be done. There are many concrete ways to help! Reach out if you or someone you know would make an excellent PM or otherwise want to put legwork into building the organization. Send precise hunches about projects and people who could form the seed of a program. Donate or invest. Or just send this piece to someone who will appreciate it.
...
[charmander_evolution]: charmander_evolution.png width=873px height=436px
...
[^fn1]: \<sidenote\> From [In the Realm of the Barely Feasible](https://issues.org/realm-of-the-barely-feasible-innovation-darpa-prabhakar/)

[^fn2]: \<sidenote\> See[ In the Realm of the Barely Feasible](https://issues.org/realm-of-the-barely-feasible-innovation-darpa-prabhakar/)

[^fn3]: It's notable that the disciplines can differ both horizontally (ie. theoretical chemists, mathematicians, and physicists) and vertically (ie. Theorists, experimentalists, engineers, manufacturers)

[^fn4]: Condition \#3 was originally "1+2 are insufficient if the technology the lab works on isn't tied into the company's core business." However, this isn't quite right. There are situations where technology work on the core product can have nothing to do with existential risks to the business (for example Salesforce.) Similarly there are situations where technology work has little to do with the core product but addresses an existential threat (for example flashy research at Bell Labs keeping regulators from breaking up the monopoly.)

[^fn5]: \<sidenote\> For a deeper dive on DARPA and a refresher on what the DARPA model entails see [Why DARPA Works](http://benjaminreinhardt.com/wddw)

[^fn6]: Theseus killed the minotaur but ultimately caused his father to commit suicide.Success? Failure?

[^fn7]: \<sidenote\> As far as I can tell, Balaji Srivasanan introduced the Idea Maze in [his Stanford Startup Course](https://spark-public.s3.amazonaws.com/startup/lecture_slides/lecture5-market-wireframing-design.pdf) and Chris Dixon made it well known [on his blog](https://cdixon.org/2013/08/04/the-idea-maze).

[^fn8]: \<sidenote\> [Generally, things are done the way they are for a reason. ](https://en.wikipedia.org/wiki/G._K._Chesterton#Chesterton's_fence)

[^fn9]: Both the terms 'innovation' and 'innovation ecosystem' are often frustrating [suitcase word](https://alexvermeer.com/unpacking-suitcase-words/)s. But it is useful to have a shorthand for "all the institutions that enable activities that collectively cover the process of an idea becoming a new impactful idea or technology."

[^fn10]: Long-term roughly translates to more than \~five years.

[^fn11]: My unsubstantiated personal opinion is that analyses on high-level metrics like total factor productivity contribute to this unhelpful lumping.

[^fn12]: \<sidenote\> See [**The Great Stagnation: How America Ate All The Low-Hanging Fruit of Modern History, Got Sick, and Will (Eventually) Feel Better**](https://www.goodreads.com/book/show/10276354-the-great-stagnation) **and a lot of related literature.**

[^fn13]: \<sidenote\> See [Where is My Flying Car?: A Memoir of Future Past](https://www.goodreads.com/book/show/42036377-where-is-my-flying-car?from_search=true&from_srp=true&qid=rTDy22OsIy&rank=1)

[^fn14]: Yes, it's a much less catchy question. And in this particular case the book does delve into the institutional constraints; many people do not.

[^fn15]: \<sidenote\> For more on breakdowns on the Scientific Process, I recommend[ Brian Nosek's work on the replication crisis](https://www.nature.com/news/over-half-of-psychology-studies-fail-reproducibility-test-1.18248) or Stuart Ritchie's book [Science Fictions](https://www.sciencefictions.org/)

[^fn16]: \<sidenote\> Polavision took ten years and half a billion dolars. In [Loonshots](https://www.goodreads.com/book/show/39863447-loonshots) Safi Bahcall attributes its failure to expensive but amazing features driven by Polaroid's founder.

[^fn17]: \<sidenote\> See [**Pasteur's Quadrant: Basic Science and Technological Innovation**](https://www.goodreads.com/book/show/701167.Pasteur_s_Quadrant)

[^fn18]: \<sidenote\> From [In the Realm of the Barely Feasible](https://issues.org/realm-of-the-barely-feasible-innovation-darpa-prabhakar/)

[^fn19]: \<sidenote\> For more about why industrial labs started see [The Changing Structure of American Innovation](https://static1.squarespace.com/static/593d9b08be65945a2e878544/t/5d31ac9b33ae9b0001d88216/1563536539717/c14259.pdf) - Some Cautionary Remarks for Economic Growth

[^fn20]: \<sidenote\> [Pasteur's Quadrant ](https://www.amazon.com/Pasteurs-Quadrant-Science-Technological-Innovation/dp/0815781776/ref=sr_1_1?crid=21T2ZKWPUWG0F&dchild=1&keywords=pasteur's+quadrant&qid=1613146396&sprefix=usb-c+to+mic,aps,206&sr=8-1)is an excellent exploration into the nuances of different types of research.

[^fn21]: Invoking Cunningham's Law, I will say this very aggressively in the hopes that I am wrong.

[^fn22]: This idea might be a fallacy. Arguably there is no platonic "ultimate stage" of a technology and whatever a technology evolves into is indelibly touched by the different specialized forms it needed to pass through.

[^fn23]: More abstractly, general purpose technology needs developmental *slack.* See [Studies on Slack.  ](https://slatestarcodex.com/2020/05/12/studies-on-slack/)

[^fn24]: There are a number of just-so stories I could tell about why these university spin-offs are different than the list of successes - most of those on the list were not deeply new technology, their founders were brilliant and plotted the exact path to success, it's easier to go into new niches with software and chips, they got lucky, I'm a moron etc. However, the empirical evidence is that so many niche-seeking startups built around new (genuinely cool) technologies fail to help that technology realize its potential.

[^fn25]: I'm *not* trying to say VC and startups suck and are broken! There are many amazing things that *have* come out of the system. What I am asserting is the incorrectness of the idea that "if it wasn't a viable startup it would never have been able to be amazing for the world in the long run"

[^fn26]: \<sidenote\> From [The Idea Factory](https://www.goodreads.com/book/show/11797471-the-idea-factory)

[^fn27]: This is a made-up term inspired by Surely You're Joking Mr. Feynman: "It was effortless. It was easy to play with these things. It was like uncorking a bottle: Everything flowed out effortlessly. I almost tried to resist it! There was no importance to what I was doing, but ultimately there was. The diagrams and the whole business that I got the Nobel Prize for came from that piddling around with the wobbling plate"

[^fn28]: \<sidenote\> For a good short article on the Valley of Death and its relationship to Technology Readiness Levels, see [Technology Readiness and the Valley of Death](https://www.boeing.com/features/innovation-quarterly/may2017/feature-thought-leadership-newman.page).

[^fn29]: Though this time period is probably longer than it would have been because it was interrupted by a world war.

[^fn30]: I will only touch on academia's constraints lightly here - only enough to draw the contrast to industrial labs. More on this later!

[^fn31]: It's worth spending more time thinking about the 'dimensions' of the valley of death - because it's not a matter of number of people as the "ramp" language here might imply.

[^fn32]: \<sidenote\> See eg. [Google X and the Science of Radical Creativity](https://www.theatlantic.com/magazine/archive/2017/11/x-google-moonshot-factory/540648/)

[^fn33]: Condition \#3 was originally "1+2 are insufficient if the technology the lab works on isn't tied into the company's core business." However, this isn't quite right. There are situations where technology work on the core product can have nothing to do with existential risks to the business (for example Salesforce.) Similarly there are situations where technology work has little to do with the core product but addresses an existential threat (for example flashy research at Bell Labs keeping regulators from breaking up the monopoly.)

[^fn34]: \<sidenote\> I'm using Knightian Uncertainty in its broader sense --- situations where there is not only uncertainty but you don't even know what the probability distribution is or even what axis to measure it on. 
	
	See [Risk, Uncertainty, and Profit.](https://archive.org/details/riskuncertaintyp00knigrich)

[^fn35]: Some people use the term money fountain - I think this makes it sound a bit too magical. Money factories are mystical enough.

[^fn36]: Figuring out how to develop technology faster is so impactful because it breaks this initial assumption and weakens the dependence on a money factory. At the same time, technology R+D+Diffusion timescales seem weirdly robust, so the burden of proof is on anyone who claims to have sped up the process.

[^fn37]: There is, of course, an entire literature about projects like this going drastically over budget and timeline.

[^fn38]: Although better program design could help!

[^fn39]: It would be fascinating if someone did a study on the full two-by-two: situations where expectations of success helped a project, hurt that project and where expectations of failure did the same.

[^fn40]: See [Finite and Infinite Games](https://www.goodreads.com/book/show/189989.Finite_and_Infinite_Games)

[^fn41]: I suspect these arguments apply to innovation organizations in general but I want to narrow the scope here a bit to just research organizations

[^fn42]: Or at least be perceived to be addressing existential threats - there are many organizations that successfully maintain funding based purely on great marketing. It's worth paying attention to why this marketing works but I'm going to otherwise ignore it because I am bad at pulling off false pretenses and would prefer if the world had fewer of them.

[^fn43]: \<sidenote\> The book [Loonshots](https://www.goodreads.com/book/show/39863447-loonshots) introduces the  concepts of "warty babies" and "the three deaths" which are incisive mental models of the phenomena that lead to project-cradle-death.

[^fn44]: This is very true of 1960's ARPA but less so of DARPA. Over time, congress has exerted more direct oversight over DARPA programs. That being said, there's still less overhead than other government research.

[^fn45]: It's unclear whether it they should even be called labs!

[^fn46]: Lockheed Martin is supposedly working on a portable fusion reactor,

[^fn47]: \<sidenote\> The memo is quite good and [available here](https://xconomy.com/national/2013/10/01/microsoft-research-memo-analysis/)

[^fn48]: \<sidenote\> For more on the first case, see the section in [Loonshots](https://www.goodreads.com/book/show/39863447-loonshots) about "Manage the transfer, not the technology" and for the second, see "Separate soldiers and scientists" (Have I convinced you to read it yet?)

[^fn49]: \<sidenote\> See [Killing the Golden Goose? The changing nature of corporate research](https://faculty.fuqua.duke.edu/~sb135/sb135/Science%201%2091%2015.pdf), 1980-2007 for an in-depth exploration of this trend.

[^fn50]: Before you write me an angry email, I am not saying that all teams at all industrial labs are now C players, but it is undeniable that most people *on the academic track* don't view industrial labs as a first-class alternative to universities.

[^fn51]: \<sidenote\> See [The decline of science in corporate R&D ](https://onlinelibrary.wiley.com/doi/abs/10.1002/smj.2693)for a more in-depth look.

[^fn52]: At this point OpenAI resembles the Bell Labs equivalent for Microsoft

[^fn53]: Yes, Google and Facebook are not technically monopolies in the full AT&T or Standard Oil sense, but the flavor of their profit margin and size is similar.

[^fn54]: Maybe it's a Seattle thing?

[^fn55]: I'm not going to dig into the philosophy of "what makes something good?" I am an unabashed explorationist, but I'm pretty sure you could make a utilitarian argument as well.

[^fn56]: Positive in the sense of "positivist" not in the sense of "Yeah! Science!"

[^fn57]: \<sidenote\> The "adjacent possible" (grossly simplified) the possible states that a system can enter, given it's current state. In the case of science and technology, it's the set of things we could \*possibly\* invent and discover given what we've already invented or discovered. The concept was originally introduced by [Stuart Kauffman in his book Investigations](https://www.goodreads.com/book/show/672512.Investigations)
...
[^fn60]: \<sidenote\> [The decline of science in corporate R&D](https://onlinelibrary.wiley.com/doi/abs/10.1002/smj.2693)

[^fn61]: Which, like the DOE itself were originally created for the sole purpose of smoothly transitioning nuclear weapons from proof of concept to manufactured product!

[^fn62]: \<sidenote\> See [The decline of science in corporate R&D](https://onlinelibrary.wiley.com/doi/abs/10.1002/smj.2693) again

[^fn63]: Broadly including institutions in theier ecosystems like venture capital, incubators, national research centers

[^fn64]: There are many others!

[^fn65]: \<sidenote\> See http://worrydream.com/LadderOfAbstraction/

[^fn66]: \<sidenote\> See Radical Abundance, Chapter 8

[^fn67]: In fact, it would be accurate to draw an arrow from the bottom of engineering design to the bottom of scientific inquiry and do the same from the top of scientific inquiry to the top of engineering design, creating an ouroboros: The mythical snake eating its own tail

[^fn68]: \<sidenote\> See <https://benjaminreinhardt.com/trl>

[^fn69]: This can of course happen outside of academia! But in academia it can go forever without running into the cold hard wall that is reality.

[^fn70]: And through self-reinforcing cultural evolution.

[^fn71]: See especially: any graduate work that involves culturing cells or working with equipment that is more than thirty years old.

[^fn72]: \<sidenote\> See [*Paper Authorship Goes Hyper*](https://www.natureindex.com/news-blog/paper-authorship-goes-hyper)

[^fn73]: \<sidenote\> See [The Structure of Scientific Discoveries](https://www.goodreads.com/book/show/61539.The_Structure_of_Scientific_Revolutions)

[^fn74]: \<sidenote\> See [**Expansion Microscopy**](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4312537/)

[^fn75]: But they were published and now have many citations! You say. Yes, after years of struggling to publish and get funding. There is a heavy survivorship bias here because there's rarely anything to point to in situations where something wasn't published.

[^fn76]: I want to use the term "antedisciplinary science" from [Sean R. Eddy's article of the same name](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.0010006) but relegated it to this footnote to avoid too many new words.

[^fn77]: Despite the fact that there is an increasingly wide gap between the number of graduate students training for PhDs and academic positions for them to fill!

[^fn78]: \<sidenote\> <http://paulgraham.com/growth.html>

[^fn79]: There will always be exceptions!

[^fn80]: "We conclude that only a miniscule fraction of the social returns from technological advances over the 1948-2001 was captured by producers" - from [Schumpeterian Profits in the American Economy - Theory and Measurement](https://www.nber.org/system/files/working_papers/w10433/w10433.pdf)

[^fn81]: \<sidenote\> See [Fundamental Manufacturing Process Innovation Changes the World](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3470660)

[^fn82]: \<sidenote\> In addition Jerry Neumann argues convincingly in that VCs rationally should avoid technical risk in [Productive Uncertainty](http://reactionwheel.net/2020/11/productive-uncertainty.html)

[^fn83]: Basically the entire world is a monetized economy as of the early 21st century. There is a whole other rabbit hole about the goodness or badness of that fact but I'm going to avoid that discussion and just treat a monetized economy as a given.

[^fn84]: This is not a new phenomenon. Newton spent the last decades of his life working at the British Mint instead of doing physics.

[^fn85]: Shannon made a killing on the stock market, but as far as anybody knows, he didn't use information theory to do it.

[^fn86]: \<sidenote\> See [The Data of Long-lived Institutions](https://blog.longnow.org/02020/10/21/the-data-of-long-lived-institutions/)

[^fn87]: \<sidenote\> Jason Crawford [argues that cash-flow also creates the tightest possible feedback loop with the world outside the organization.](https://rootsofprogress.org/organizational-metabolism-and-the-for-profit-advantage)

[^fn88]: \<sidenote\> "[When a measure becomes a target, it ceases to be a good measure](https://en.wikipedia.org/wiki/Goodhart's_law)."

[^fn89]: To complicate things, many small contracting firms *only* work for the US government so they may be part of the government for all intents and purposes.

[^fn90]: My past self included.

[^fn91]: \<sidenote\> [The Mother of All Demos](https://en.wikipedia.org/wiki/The_Mother_of_All_Demos) was Douglas Engelbart's tour-de-force where he demonstrated the majority of what has become modern computing in 1968.

[^fn92]: \<Sidenote\> See[ Scientific Knowledge as a Global Public Good - Contributions to Innovation and the Economy](https://www.ncbi.nlm.nih.gov/books/NBK221876/).

[^fn93]: I am not a lawyer, this is not legal advice.

[^fn94]: The Wright Brothers famously spent a lot of time litigating patents.

[^fn95]: Charles Goodyear - one of the inventors of vulcanized rubber lost a series of court cases and made little money from his invention.

[^fn96]: If the technology is modular enough that it can easily be sold and incorporated into many other products, it's still just a product.

[^fn97]: Yes, you can probably come up with an obscure scenario where studying these things (or anything) is valuable. My point is that justifying research based on the value it creates at all is an incomplete stance.

[^fn98]: Prove me wrong please!

[^fn99]: \<sidenote\> See [Tacit Knowledge, Trust, and the Q of Sapphire](https://www.gwern.net/docs/philo/2001-collins.pdf)

[^fn100]: \<sidenote\> See [Congressional Tribute to Dr. Norman E. Borlaug Act of 2006 ](https://www.govinfo.gov/content/pkg/PLAW-109publ395/html/PLAW-109publ395.htm)

[^fn101]: I'm going to just talk about patents but the same arguments apply to both

[^fn102]: This is two orders of magnitude larger than US population growth.

[^fn103]: \<sidenote\> See [Age of Invention: How to Build a State](https://antonhowes.substack.com/p/age-of-invention-how-to-build-a-state)

[^fn104]: \<sidenote\> See [Productive Uncertainty](http://reactionwheel.net/2020/11/productive-uncertainty.html)

[^fn105]: \<sidenote\> For a much deeper discussion about where patents are helpful or harmful see [The Patent Crisis and How the Courts Can Solve It](https://www.goodreads.com/book/show/6885496-the-patent-crisis-and-how-the-courts-can-solve-it)

[^fn106]: '[Heuretic' is a better word](https://twitter.com/antonhowes/status/1252638141577662482), but I've introduced enough new terms as it is.

[^fn107]: \<sidenote\> This section only skims the surface of this topic as far as we need to understand the sorts of technologies that current institutions have trouble enabling. For a much deeper dive see the already-mentioned-but-worth-mentioning-again [The Patent Crisis and How the Courts Can Solve It](https://www.goodreads.com/book/show/6885496-the-patent-crisis-and-how-the-courts-can-solve-it)

[^fn108]: \<sidenote\> See [The Nature of Technology:What it is and How It Evolves](https://www.goodreads.com/book/show/6321234-the-nature-of-technology) and [One Process](http://reactionwheel.net/2020/04/one-process.html)

[^fn109]: Composability is an excellent and under discussed concept. <https://en.wikipedia.org/wiki/Composability>

[^fn110]: It was (and still is) a giant cost and pain.

[^fn111]: In the sense of ['charismatic megafauna'](https://en.wikipedia.org/wiki/Charismatic_megafauna)

[^fn112]: See <https://en.wikipedia.org/wiki/Wright_brothers_patent_war>

[^fn113]: There literally is an academic argument over this. For arguments that patent thickets did stifle airplane development see [Spillover Effects of Intellectual Property Protection in the Interwar Aircraft Industry](https://academic.oup.com/icc/article-abstract/24/1/1/824074) and for arguments that patents weren't a problem see [The myth of the early aviation patent hold-up---how a US government monopsony commandeered pioneer airplane patents](https://academic.oup.com/icc/article-abstract/24/1/1/824074). I find the former compelling but it's tricky.

[^fn114]: \<sidenote\> See [Not Counting Chemistry: How We Misread the History of 20th-Century Science and Technology  ](https://www.sciencehistory.org/distillations/not-counting-chemistry-how-we-misread-the-history-of-20th-century-science-and)

[^fn115]: \<sidenote\> See [The Decline of Science in Corporate R&D](https://onlinelibrary.wiley.com/doi/abs/10.1002/smj.2693) (again)

[^fn116]: \<sidenote\> See [This Interview with Alan Kay](https://juxt.pro/blog/alan-kay)

[^fn117]: The equivalent of suing someone who isn't paying the licensing fees on a patent.

[^fn118]: \<sidenote\> See [A Brief History of the Corporate Form and Why it Matters](https://news.law.fordham.edu/jcfl/2018/11/18/a-brief-history-of-the-corporate-form-and-why-it-matters/)

[^fn119]: \<sidenote\> See [The Modern Corporation and Private Property](http://www.goodreads.com/book/show/781883.The_Modern_Corporation_and_Private_Property).

[^fn120]: Note that this isn't a good or a bad thing - while the default reaction at least in Silicon Valley circles is that it is.

[^fn121]: Although cognitive-dissonance-introducingly there are non-profits that make a large profit in everything but the legal sense, and for-profits that don't seek to maximize profits at all.

[^fn122]: \<sidenote\>From [VC Funds 101: Understanding Venture Fund Structures, Team Compensation, Fund Metrics and Reporting \| by Ahmad Takatkah \| VCpreneur](https://vcpreneur.com/vc-funds-101-understanding-venture-fund-structures-team-compensation-fund-metrics-and-reporting-152b02e8504a)

[^fn123]: Less-used tax designations vary both over space and time like S-corps or Benefit Corps. For example, as of late 2020, benefit corporations are authorized in 35/50 US states. They exist in some states but not in other states and are legislated into existence and sometimes out of existence.

[^fn124]: That is, particle physics before subatomic particles, now it's just a mess all the way down.

[^fn125]: The property that you don't actually know where the line is until you cross it is true in law more broadly. Some legal scholars in common-law countries like the US consider it a *good* thing when laws are challenged because more rulings give a better sense of where the line is.

[^fn126]: Admittedly, the number of organizations constrained out of existence by people being unwilling to play with legal structures might be zero. But it also might be huge. Counterfactuals are hard!

[^fn127]: \<sidenote\> See <https://openai.com/blog/openai-lp/>

[^fn128]: One could argue how much of this is just talk, but I default to trust and it helps argue my point.

[^fn129]: Former PMs are still (understandably) hesitant to talk about could-have-been program ideas.

[^fn130]: \<sidenote\> See for example the history of DARPA's drone program in [The DARPA Model for Transformative Technologies: Perspectives on the U.S. Defense Advanced Research Projects Agency](https://www.openbookpublishers.com/product/1079)

[^fn131]: Which

[^fn132]: \<sidenote\> See [A new UK research funding agency](https://committees.parliament.uk/publications/4665/documents/47032/default/)

[^fn133]: And even then it depends on which government you are part of.

[^fn134]: I want to caveat that the moon landings could not have been accomplished without government funding *in the 60s.* Whether something requires government-level funding is not an inherent property of that thing but instead depends on the nature of the work at the time, the relative wealth of the society, and the concentration of that wealth. In the 1960s, NASA needed to do a *ton* of new things, the US was not as wealthy as it is now, and that wealth was less concentrated (fewer billionaires.)

[^fn135]: \<sidenote\> See [Why Does DARPA Work](https://benjaminreinhardt.com/wddw#opacity_is_important_to_darpa%E2%80%99s_outlier_success)?

[^fn136]: \<sidenote\> See the [Room for Improvement section of Why Does DARPA Work?](https://benjaminreinhardt.com/wddw#room_for_improvement)

[^fn137]: I like to think of this like how polynomial approximations are valid in a local area around an equilibrium.

[^fn138]: There are few things more fun to talk about than how messed up your old company was.

[^fn139]: These people should not visit climbing gyms.

[^fn140]: The University of Utah CS department is notorious for early computer graphics work like the [Utah Teapot](https://en.wikipedia.org/wiki/Utah_teapot). Pixar Founder Ed Catmul is a direct descendent of this tradition.

[^fn141]: There's not a great word for these people. "End-users" sounds incredibly clinical and alternatives like "consumers" invokes large numbers of unsophisticated people.

[^fn142]: (Who/which member of an organization is actually spending the money? Who do you need to convince that it's a good idea? How does the customer know it works? What does the contract look like? Do you need to go through a third party? These are of course questions for any product (and invite innovation!) but more established types of products have more standard answers.

[^fn143]: Obviously there is much more haggling involved but it is a much more straightforward conversation for both sides.

[^fn144]: This word also feels insufficient, but is the commonly-used word for "getting technology to end-users." I'm going to be a bit sloppy and jump between "selling" and "diffusing."

[^fn145]: \<sidenote\> See the [NVCA 2017 Yearbook](http://nvca.org/nvca-2017-yearbook-go-resource-venture-ecosystem/)

[^fn146]: At least at the program level.

[^fn147]: \<sidenote\> See [DARPA uses low-stakes seedling programs to 'acid test' the riskiest part of a program idea.](https://benjaminreinhardt.com/wddw#darpa_pms_use_seedling_projects_to_%E2%80%98acid_test%E2%80%99_the_riskiest_pieces_of_a_program_idea) ⁠

[^fn148]: To paint the counterfactual of explicitly making sure experiments have no negative consequences: One could imagine that after a failed seedling experiment a PM could implicitly or explicitly need to 'redeem' themselves by going above and beyond. Similarly, the organizational attitude towards a performer who ran a failed experiment might implicitly shift towards "well they're good people but a bit incompetent."

[^fn149]: As opposed to something like flossing where people are like "yeah I really should be doing that ... later."

[^fn150]: This is an example of the more general principle that optimizing individual components of a system is often at odds with the system itself.

[^fn151]: In chemistry, [free radicals are atoms, molecules, or ions with an unpaired valence electron that makes them extremely reactive.](https://en.wikipedia.org/wiki/Radical_(chemistry))

[^fn152]: \<sidenote\> See The Idea Factory

[^fn153]: \<sidenote\> See [A large part of a DARPA program manager's job is focused network building](https://benjaminreinhardt.com/wddw#a_large_part_of_a_darpa_program_manager%E2%80%99s_job_is_focused_network_building)

[^fn154]: \<sidenote\> From The Idea Factory again.

[^fn155]: \<sidenote\> See [Fundamental Manufacturing Process Innovation Changes the World](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3470660).

[^fn156]: The term 'Relationships' is usually a [suitcase handle word ](https://notes.benjaminreinhardt.com/Suitcase_Handle_Word)so I'm going to strive to be as specific as possible here

[^fn157]: Ack! So many suitcase words!

[^fn158]: It's jumping ahead a bit but This is a key reason why it's important to a replicable institutional model.

[^fn159]: "I'm busy writing my thesis. Here's my lab computer - it has everything on it. Good luck!"

[^fn160]: People absolutely run out of patience even if you set expectations up front. See: <https://twitter.com/Ben_Reinhardt/status/1350507766381744128>

[^fn161]: \<sidenote\> The Buxton Index comes from E.W.Dijkstra in [The Strengths of the Academic Enterprise ](https://www.cs.utexas.edu/users/EWD/transcriptions/EWD11xx/EWD1175.html)

[^fn162]: Peter van Hardenberg poetically names this an organization's "Reaper function"

[^fn163]: Though of course circumstances could have changed to make this no longer true.

[^fn164]: 'Friendly investment' is what I would call investment from non-professional investors that is some superposition of philanthropy and investment. That is, unlike professional investors who implicitly or explicitly want to see a certain level of growth on a clear timeline, friendly investment is more like an option - if the asset becomes worth something, awesome but if not disappointing but 🤷‍♂️. Of course, friendly investment always runs the risk of becoming unfriendly at any time - the classic example is entrepreneurs who get their first startup money from friends and family who have no experience with startup investing. A lot of angel investing could be considered 'friendly investing.'

[^fn165]: \<sidenote\> See [Department of Defense Fiscal Year (FY) 2020 Budget Estimates](https://www.darpa.mil/attachments/DARPA_FY20_Presidents_Budget_Request.pdf)

[^fn166]: Of course, individuals within organizations also have their own agendas.

[^fn167]: I only took the top 20 companies because company valuation roughly follows a power law so the bottom 200 will probably add up to be much less than the top 20.

[^fn168]: See[ **Running The Numbers on Y Combinator's Best Year Yet**](https://news.crunchbase.com/news/y-combinator-biggest-startups-gone-public-airbnb-doordash/)

[^fn169]: There are obvious exceptions for extremely expensive or rare equipment

[^fn170]: \<sidenote\> See [DARPA doesn't do ay research in house](https://benjaminreinhardt.com/wddw#darpa_doesn%E2%80%99t_do_any_research_in_house)

[^fn171]: \<sidenote\> See [Rethinking the role of the state in technology development: DARPA and the case for embedded network governance points ](https://papers.ssrn.com/sol3/papers.cfm?abstract_id%3D1545155)

[^fn172]: As cringe as this term is

[^fn173]: \<sidenote\> See [Most DARPA clones start too big or with heavy process](https://benjaminreinhardt.com/wddw#most_darpa_clones_start_too_big_or_with_heavy_process)

[^fn174]: \<sidenote\> See [DARPA---Enabling Technical Innovation](https://www.openbookpublishers.com/htmlreader/978-1-78374-791-7/ch10.xhtml)

[^fn175]: \<sidenote\> See numbers appendix

[^fn176]: \<sidenote\> See [Department of Defense Fiscal Year (FY) 2020 Budget Estimates](https://www.darpa.mil/attachments/DARPA_FY20_Presidents_Budget_Request.pdf) and [in spreadsheet form here](https://docs.google.com/spreadsheets/d/1qw3_A2P6y4rj-h_ailqoRdMFBmgwhN2ne2Ivk5lHwd8/edit?usp=sharing)

[^fn177]: \<sidenote\> See [Arpa Does Windows: The Defense Underpinning of the PC Revolution](https://www.researchgate.net/publication/46555488_Arpa_Does_Windows_The_Defense_Underpinning_of_the_PC_Revolution)

[^fn178]: \<sidenote\> See [Arpa Does Windows: The Defense Underpinning of the PC Revolution](https://www.researchgate.net/publication/46555488_Arpa_Does_Windows_The_Defense_Underpinning_of_the_PC_Revolution)

[^fn179]: \<sidenote\> See [**If Patents Are So Valuable Why Does IBM's Intellectual Property Revenue Continue To Decline**](https://www.forbes.com/sites/chuckjones/2016/01/19/if-patents-are-so-valuable-why-does-ibms-intellectual-property-revenue-continue-to-decline/?sh=51f1783c1433)

[^fn180]: \<sidenote\> See [Benchmarking of Technology Transfer Offices and What It Means for Developing Countries](http://www.iphandbook.org/handbook/ch03/p05/)

[^fn181]: \<sidenote\> See [Canada needs a national overhaul of university IP policies](https://www.universityaffairs.ca/opinion/in-my-opinion/canada-needs-national-overhaul-university-ip-policies/)

[^fn182]: \<sidenote\> For more on Deep Science Ventures and Tandemlaunch see Episodes [19](https://ideamachinespodcast.com/mark-hammond) and [30](https://ideamachinespodcast.com/eleonora-vella) of the Idea Machines podcast respectively.

[^fn183]: \<sidenote\> See <https://www.intellectualventures.com/spinouts>

[^fn184]: It's worth noting that of these, only the Santa Fe institute does not have a large endowment.

[^fn185]: While not official, my understanding is that after struggling to find funding Dynamicland closed its doors in 2020 (in part due to COVID-19 but that was only final nail.)

[^fn186]: "When a measure becomes a target, it ceases to be a good measure"

[^fn187]: Charities can't lock in commitments the way for-profit funds can

[^fn188]: 'Small' here is \<2% of total funding

[^fn189]: \<sidenote\> [Howstuffworks has a reasonable explainer](https://money.howstuffworks.com/economics/volunteer/starting-a-charity/rules-charities-follow.htm)

[^fn190]: \<sidenote\> See [Opacity is important to DARPA's outlier success](https://benjaminreinhardt.com/wddw#opacity_is_important_to_darpa%E2%80%99s_outlier_success)

[^fn191]: Foundations are legally required to disburse at least 5% of their assets towards their charitable mission every year.

[^fn192]: Legally, foundations aren't allowed to make 'excessively risky investments.'

[^fn193]: Are you starting to see why all these legal shenanigans matter?

[^fn194]: Yes, I'm using an absurd number of quotation marks - this is yet another artifact of the fact that There are no first principles for legal structures! All of these words are legal designations, but it's nebulous which things fall in and out of them.
...
[^fn196]: \<sidenote\> See [Donor-Advised Funds: an underutilized philanthropic vehicle to support innovation in science and engineering](https://primecoalition.org/wp-content/uploads/2018/03/MIT-Innovation-Initiative_DAFs.pdf?x48191) for many more details

[^fn197]: \<sidenote\> For a more in-depth flowchart of the different ways PRIs can happen based on different constraints see [Foundations: exploring the emerging practice of philanthropic investing to support innovation in science and engineering](https://primecoalition.org/wp-content/uploads/2018/03/MIT-Innovation-Initiative-Foundations-Final.pdf?x48191)

[^fn198]: \<sidenote\> See[ It is relatively easy for DARPA PMs to re-deploy funding](https://benjaminreinhardt.com/wddw#it_is_relatively_easy_for_darpa_pms_to_re-deploy_funding)

[^fn199]: Of course, members of a consortium are not automatically bought in to everything that comes out of it

[^fn200]: Spoiler alert: Speculatively, this is a good idea!

[^fn201]: \<sidenote\> See [Reflections on 2020 as an Independent Researcher](https://andymatuschak.org/2020/) for a more in-depth description of this approach.

[^fn202]: \<sidenote\> See <http://catalog.mit.edu/mit/research/mit-media-lab/>

[^fn203]: Beyond reporting requirements which as we'll see are thick strings indeed

[^fn204]: Of course, the government is composed of individuals who all have their own agendas and geographies.

[^fn205]: \<sidenote\> See [How to access 'America's Seed Fund,' the $3 billion SBIR program](https://techcrunch.com/2020/08/07/how-to-access-americas-seed-fund-the-3-billion-sbir-program/)

[^fn206]: This is why unrestricted money is like gold for professors

[^fn207]: \<sidenote\> Including Intuitive Surgical, E-Trade, Symantec, etc. See t[his Wikipedia page ](https://en.wikipedia.org/wiki/List_of_SRI_International_spin-offs)for a full list.

[^fn208]: Except for it's majority-internalized research DeepMind is basically an AI-focused DARPA-riff.

[^fn209]: DeepMind is technically an Alphabet subsidiary with its own leadership, budgets, etc.

[^fn210]: \<sidenote\> See [**DeepMind revenue dwarfed by $649 million loss**](https://www.industryleadersmagazine.com/deepmind-revenue-dwarfed-by-649-million-loss/)

[^fn211]: Google Brain's timeline corroborates this: it started as a small project within Google X in 2011 and only became a full organization around 2013.

[^fn212]: "The best way to predict the future is to invent it" --- [Alan Kay](https://www.goodreads.com/quotes/61-the-best-way-to-predict-the-future-is-to-invent)

[^fn213]: \<sidenote\> See [Department of Defense Fiscal Year (FY) 2020 Budget Estimates](https://www.darpa.mil/attachments/DARPA_FY20_Presidents_Budget_Request.pdf)

[^fn214]: \<sidenote\> See [The End of AT&T](https://spectrum.ieee.org/tech-history/dawn-of-electronics/the-end-of-att) (might require a free account login.)

[^fn215]: \<sidenote\> See [The making of American industrial research : science and business at GE and Bell 1876-1926](https://www.goodreads.com/book/show/4533514-the-making-of-american-industrial-research?ac=1&from_search=true&qid=dS5KvCWvTF&rank=1)

[^fn216]: \<sidenote\> See the list on wikipedia [here](https://en.wikipedia.org/wiki/List_of_colleges_and_universities_in_the_United_States_by_endowment)

[^fn217]: \<sidenote\> See [HHMI Financials](https://www.hhmi.org/about/financials)

[^fn218]: Contra an 'impossible' situation where the number came out bigger than the market capitalization of Amazon, for example.

[^fn219]: \<sidenote\> See [What makes DARPA tick](https://science.sciencemag.org/content/351/6273/549)

[^fn220]: \<sidenote\> See [this PG essay about unrestricted donations](http://paulgraham.com/donate.html)

[^fn221]: \<sidenote\> See [**Loonshots: How to Nurture the Crazy Ideas That Win Wars, Cure Diseases, and Transform Industries**](https://www.goodreads.com/book/show/39863447-loonshots)

[^fn222]: \<sidenote\> See [Focused Research Organizations to Accelerate Science, Technology, and Medicine](https://www.dayoneproject.org/post/focused-research-organizations-to-accelerate-science-technology-and-medicine).

[^fn223]: \<sidenote\> See [Fund people, not projects I: The HHMI and the NIH Director's Pioneer Award](https://nintil.com/hhmi-and-nih) and the other parts of the same series for a deep dive on the literature around this

[^fn224]: [Farnam Street --- Wittgenstein: Reality is shaped by the words we use](http://fs.blog/2013/01/reality-is-shaped-by-the-words-we-use/)

[^fn225]: \<sidenote\> See [The decline of unfettered research](http://www.dtc.umn.edu/~odlyzko/doc/decline.txt) for a good description of this process and its consequences

[^fn226]: \<sidenote\> There are some exceptions! [The International Technology Roadmap for Semiconductors](https://en.wikipedia.org/wiki/International_Technology_Roadmap_for_Semiconductors) is quite good, I presume because an entire massive industry *actually* depends on coordinated research.

[^fn227]: Yes "better" is a vague word. In the context of program design means some combination of "faster, cheaper, more successfully, enabling programs that wouldn't exist otherwise, and generating more knowledge in both successes and failures."

[^fn228]: Many disciplines which are meant to supplement practice suffer the same fate!

[^fn229]: \<sidenote\> See [The Secrets of Apollo](https://www.goodreads.com/book/show/218247.The_Secret_of_Apollo) or the [PERT guide for Management](https://play.google.com/books/reader?id=MojXzaEeWswC&hl=en&pg=GBS.PA16).

[^fn230]: I have tried to track them down to ask them but they seem to all be unreachable or dead. If you know any of them, please put us in touch!

[^fn231]: \<sidenote\> [Six Sigma](https://en.wikipedia.org/wiki/Six_Sigma) is Motorola's process-improvement process.

[^fn232]: \<sidenote\> [Matrix management ](https://en.wikipedia.org/wiki/Matrix_management)is a now-disfavored project management approach created by the aerospace industry in the 1950s

[^fn233]: \<sidenote\> See [**And Suddenly the Inventor Appeared: Triz, the Theory of Inventive Problem Solving**](https://www.goodreads.com/book/show/161916.And_Suddenly_the_Inventor_Appeared)

[^fn234]: See: alchemy, astrology, humor-based medicine

[^fn235]: In the Popperian sense

[^fn236]: \<sidenote\> See [How can we develop transformative tools for thought?](https://numinous.productions/ttft/#serious-work)

[^fn237]: Simulations, specifically simulating nuclear detonations, were among the first applications of digital computers.

[^fn238]: \<sidenote\> See [AlphaFold: Using AI for scientific discovery](https://deepmind.com/blog/article/AlphaFold-Using-AI-for-scientific-discovery) and [FermiNet: Quantum Physics and Chemistry from First Principles](https://deepmind.com/blog/article/FermiNet)

[^fn239]: And ideally non-researchers! Foldit is an inspiring example of sim

[^fn240]: I would argue that this is the case despite recent (2021) events.

[^fn241]: There are of course exceptions and those people go work in finance.

[^fn242]: \<sidenote\> I honestly could not find any great resources on how co-ops work. The best I could do is[ this Ohio State University site](https://u.osu.edu/coopmastery/). If you know of any better ones, please let me know!

[^fn243]: Which does happen sometimes! From *The Prince*: "There is nothing more difficult to take in hand, more perilous to conduct or more uncertain in its success, than to take the lead in the new order of things; because the innovator has for enemies all those who have done well under the old conditions, and lukewarm defenders in those who may do well under the new."

[^fn244]: \<sidenote\> In a grossly oversimplified nutshell, SPACs (Special Purpose Acquisition Companies) are publicly listed shell companies that then merge will a private company, effectively taking it public without an IPO. Wikipedia article [here.](https://en.wikipedia.org/wiki/Special-purpose_acquisition_company)

[^fn245]: \<sidenote\> Anton Howes has a good Twitter thread about Advanced Market Commitments [here](https://twitter.com/antonhowes/status/1250431243407069184)

[^fn246]: \<sidenote\> See [Productive Uncertainty](https://reactionwheel.net/2020/11/productive-uncertainty.html)

[^fn247]: \<sidenote\> See a more detailed description of technology readiness levels [here ](https://benjaminreinhardt.com/trl)

[^fn248]: I want to acknowledge up-front that 'vision' and 'visionary' has become a grossly overloaded suitcase word. Unfortunately, it is also the correct word for what I'm talking about. I tried 'crisp picture' or 'shared goal' but they just don't work. It's also hard to define in a non-circular manner from the content of this note. Hopefully this excessive note serves to sufficiently discriminate precise visions from the casual use of the word!

[^fn249]: \<sidenote\> See [As We May Think](https://www.theatlantic.com/magazine/archive/1945/07/as-we-may-think/303881/) (uses up one of three free articles at The Atlantic)

[^fn250]: "What are you working on?" Is an intriguing question. What counts as a legitimate answer to it is slippery. There are answers that are clearly legitimate like "we're working on making webpage load times faster!" Unfortunately, "we're working on a new institutional structure" is generally illegitimate. Perhaps it comes down to whether the questioner can imagine the sorts of day-to-day activities an answer would entail?

[^fn251]: There are of course, many examples of startups drastically shifting what they're working on. At any point in time though, good startups tend to know exactly what they're working on.

[^fn252]: This isn't to say all software engineers or data scientists are fungible! It is to say that the startup's ability to take even one step forward doesn't hinge on hiring the best software engineer in the world.

[^fn253]: There are plenty of people who have no idea what they're talking with great ideas that would change the world if only they could find someone to implement them.

[^fn254]: The counterexamples that immediately popped into your head are the result of saliency bias. It's easy to recall people who openly want to work on things beyond their reach but obviously hard to recall the people who never talk about.

[^fn255]: I think credentialism is bad and that most people can retrain to do most things eventually if they try hard. However, success on a technically-hard non-software research project starting from scratch without guidance seems ... unlikely.

[^fn256]: The tension between expertise and ambition strikes again!

[^fn257]: \<sidenote\> Warren Weaver, the Rockefeller Foundation program officer who funded early genetics work expands on this point in his [notes for other program officers](https://rockfound.rockarch.org/digital-library-listing/-/asset_publisher/yYxpQfeI4W8N/content/n-s-notes-on-officers-techniques).

[^fn258]: \<sidenote\> See [DARPA PMs use seedling projects to 'acid test' the riskiest pieces of a program idea](https://benjaminreinhardt.com/wddw#darpa_pms_use_seedling_projects_to_%E2%80%98acid_test%E2%80%99_the_riskiest_pieces_of_a_program_idea)

[^fn259]: \<sidenote\> The last four are directly from Adam Marblestone.

[^fn260]: \<sidenote\> See [A large part of a DARPA program manager's job is focused network building](https://benjaminreinhardt.com/wddw#a_large_part_of_a_darpa_program_manager%E2%80%99s_job_is_focused_network_building)

[^fn261]: See question \#4 of The Heilmeier Catechism: " Who cares? If you are successful, what difference will it make?"

[^fn262]: \<sidenote\> In [Reinventing Discovery](https://www.goodreads.com/book/show/11667578-reinventing-discovery), Michael Nielsen elegantly describes this process as 'designed serendipity'

[^fn263]: I prefer the imagery invoked by 'budding off' companies instead of spinning out, but the convention is strong with this one.

[^fn264]: \<sidenote\> See [Default Alive or Default Dead](http://paulgraham.com/aord.html)

[^fn265]: Though they rarely do in practice

[^fn266]: \<sidenote\> See [DARPA is relatively tiny and flat](https://benjaminreinhardt.com/wddw#darpa_is_relatively_tiny_and_flat)

[^fn267]: 1974 Bell Labs and 2020 DARPA have uncannily similar budgets ($3.6B and $2.8B in 2020 dollars) - there is not clear causal linkage but it is suggestive.

[^fn268]: \<sidenote\> For much more about ARDC see [Creative Capital: Georges Doriot and the Birth of Venture Capital](https://www.goodreads.com/book/show/3176553-creative-capital)

[^fn269]: If every company whose core business depends on technology that can be traced back to DARPA gave some tiny percent of their revenue to DARPA, it would fund DARPA many times over. (And in a way they do, via taxes in the US)

[^fn270]: \<sidenote\> See [Productive Uncertainty](http://reactionwheel.net/2020/11/productive-uncertainty.html)

[^fn271]: As with any metric, it will be very imperfect. It's not actually possible to convert between four years of service and $200k. Both are essential and uninterchangable.

[^fn272]: \<sidenote\> Evolutionary systems (may) go through long periods of slow change punctuated by periods of rapid change. See [Punctuated equilibria: an alternative to phyletic gradualism](https://www.blackwellpublishing.com/ridley/classictexts/eldredge.pdf)

[^fn273]: \<sidenote\> For some more complex and well-thought-out tranched funding schemes, see [Funding Long Shots](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3058472).

[^fn274]: **While a DARPA-riff will need at least seven programs to demonstrate viability, we could design the remaining programs once we've moved to Form 2.**

[^fn275]: I've gotten different response rates sending emails with the slightly different wording "potential privately funded research program ..." and just "potential research program ..."

[^fn276]: \<sidenote\> See[ Focused Research Organizations to Accelerate Science, Technology, and Medicine](https://www.dayoneproject.org/post/focused-research-organizations-to-accelerate-science-technology-and-medicine)

[^fn277]: \<sidenote\> See <https://www.darpa.mil/work-with-us/heilmeier-catechism>

[^fn278]: Speculatively, it might be possible to improve on the Heilmeier Catechism with something more quantized - similar to Donald Braben's BRAVERI scale.

[^fn279]: \<sidenote\> See[ DARPA - Enabling Technical Innovation by Jitendra Ranka](https://www.openbookpublishers.com/htmlreader/978-1-78374-791-7/ch10.xhtml)

[^fn280]: You also need some amount of slack for these benefits to kick in. If everybody is spending 110% of the their time focused on only their own programs any non-program-related interaction is mentally expensive.

[^fn281]: \<sidenote\> See T[he density of remaining nerve endings in human skin with and without postherpetic neuralgia after shingles](https://doi.org/10.1016/S0304-3959(00)00481-4)

[^fn282]: \<sidenote\> See[ The BioTac - Multimodal Tactile Sensor](https://wiki.ros.org/BioTac)

[^fn283]: \<sidenote\> See the[ Drexler-Smalley debate](https://en.wikipedia.org/wiki/Drexler%E2%80%93Smalley_debate_on_molecular_nanotechnology) for strong arguments against positional chemistry.

[^fn284]: Note that I'm *not* saying this is necessarily the right thing to build, but it does seem promising.

[^fn285]: \<sidenote\> See [DNA Strand Displacement-Driven DNA Origami Tools and Materials](https://www.energy.gov/sites/prod/files/2019/09/f66/DNA%20Strand%20Displacement%20Driven%20Molecular%20Additive%20Manufacturing.pdf).

[^fn286]: \<sidenote\> See [**Design of a single-chain polypeptide tetrahedron assembled from coiled-coil segments**](https://www.nature.com/articles/nchembio.1248)**.**

[^fn287]: \<sidenote\> See [Ultrafast rotation in an amphidynamic crystalline metal organic framework](https://www.pnas.org/content/pnas/114/52/13613.full.pdf).

[^fn288]: \<sidenote\> See [Casting inorganic structures with DNA molds.](https://science.sciencemag.org/content/346/6210/1258361.full)

[^fn289]: \<sidenote\> This term originally comes from another DARPA-riff, Activate. See [In the Realm of the Barely Feasible](https://issues.org/wp-content/uploads/2020/09/34-40-Prabhakar-In-the-Realm-of-the-Barely-Feasible-Fall-2020-ISSUES.pdf).

[^fn290]: This distinction between leading indicator and goal in of itself is of course the root of Goodhart's law. We can hopefully sidestep the trap of leading indicators becoming goals by having too many indicators to pursue all of them without just pursuing the thing they indicate!

[^fn291]: \<sidenote\> See [Reflections on 2020 as an independent researcher](https://andymatuschak.org/2020/)

[^fn292]: \<sidenote\> See [**Scenius, or Communal Genius**](https://kk.org/thetechnium/scenius-or-comm/)

[^fn293]: While Xerox PARC technically still exists, after a leadership change in 1983 it arguably morphed into a different organization.

[^fn294]: This is a yet-to-be-made tracker of how close we are to the technologies in Ian M. Banks Culture Series.

[^fn295]: \<sidenote\> A scale ranking civilizational levels by the amount of energy they can consume - Level 1 is consuming energy at the scale of all the energy incident to the surface of their planet, Level 2 is consuming energy at the scale of their local star, and Level 3 is consuming energy at the scale of their galaxy. See [Kardashev scale - Wikipedia](https://en.wikipedia.org/wiki/Kardashev_scale).

[^fn296]: \<sidenote\>'Ergophobia" technically means a neurotic fear of doing work, in an individual. But it comes from the same Greek root as "energy," and you will find that physicists use "work" and "energy" to mean the same thing. So I feel justified in using it to refer to the funk our society has gotten into over energy.' From: *Where Is My Flying Car?: A Memoir of Future Past.*

[^fn297]: \<sidenote\>"When a elder preeminent scientist says that something is impossible, he's probably wrong. When a elder preeminent scientist says something might be possible, he's probably right."

[^fn298]: the P is for private, but you can also imagine that it stands for Phenomenal or Prodigious if you want